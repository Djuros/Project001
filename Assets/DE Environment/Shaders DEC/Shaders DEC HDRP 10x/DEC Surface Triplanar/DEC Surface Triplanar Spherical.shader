...
Shader "DEC/Surface Triplanar/Triplanar Spherical"
{
	Properties
	{
		...
		[ASEEnd]_NormalStrengthBent("Bent Normal Strength", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 SmoothnessTypefloat4switch215_g43401( float m_switch, float4 m_Smoothness, float4 m_Roughness, float4 m_Geometric )
			{
				if(m_switch ==0)
					return m_Smoothness;
				else if(m_switch ==1)
			...
			float4 SmoothnessTypefloat4switch215_g43389( float m_switch, float4 m_Smoothness, float4 m_Roughness, float4 m_Geometric )
			{
				if(m_switch ==0)
					return m_Smoothness;
				else if(m_switch ==1)
						...
						)
			{
				...
				float _UV_SPACE2529_g43387 = _Blend_Space;
				float temp_output_62_0_g43412 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43415 = lerp( ase_worldPos , packedInput.ase_texcoord5.xyz , temp_output_62_0_g43412);
				float3 break10_g43412 = lerpResult99_g43415;
				float2 appendResult13_g43412 = (float2(break10_g43412.y , break10_g43412.z));
				float2 appendResult154_g43387 = (float2(_Bottom_TilingX , _Bottom_TilingY));
				float2 BOTTOM_Tilling563_g43387 = appendResult154_g43387;
				float2 temp_output_60_0_g43412 = BOTTOM_Tilling563_g43387;
				float2 appendResult153_g43387 = (float2(_Bottom_OffsetX , _Bottom_OffsetY));
				float2 BOTTOM_Offset561_g43387 = appendResult153_g43387;
				float2 temp_output_61_0_g43412 = BOTTOM_Offset561_g43387;
				float2 UV_0121_g43412 = ( ( appendResult13_g43412 * temp_output_60_0_g43412 ) + temp_output_61_0_g43412 );
				float3 WorldNormal83_g43413 = normalWS;
				float3 lerpResult99_g43413 = lerp( WorldNormal83_g43413 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43413 , 0.0 ) ).xyz , temp_output_62_0_g43412);
				float3 temp_output_33_0_g43412 = abs( lerpResult99_g43413 );
				float dotResult30_g43412 = dot( temp_output_33_0_g43412 , float3(1,1,1) );
				float3 BLEND36_g43412 = ( temp_output_33_0_g43412 / dotResult30_g43412 );
				float3 break48_g43412 = BLEND36_g43412;
				float2 appendResult15_g43412 = (float2(break10_g43412.x , break10_g43412.z));
				float2 UV_0220_g43412 = ( ( appendResult15_g43412 * temp_output_60_0_g43412 ) + temp_output_61_0_g43412 );
				float2 appendResult25_g43412 = (float2(break10_g43412.x , break10_g43412.y));
				float2 UV_0327_g43412 = ( ( appendResult25_g43412 * temp_output_60_0_g43412 ) + temp_output_61_0_g43412 );
				float4 temp_output_59_0_g43412 = ( ( ( SAMPLE_TEXTURE2D( _Bottom_MainTex, sampler_trilinear_repeat_aniso2, UV_0121_g43412 ) * break48_g43412.x ) + ( SAMPLE_TEXTURE2D( _Bottom_MainTex, sampler_trilinear_repeat_aniso2, UV_0220_g43412 ) * break48_g43412.y ) ) + ( SAMPLE_TEXTURE2D( _Bottom_MainTex, sampler_trilinear_repeat_aniso2, UV_0327_g43412 ) * break48_g43412.z ) );
				float4 temp_output_2592_78_g43387 = temp_output_59_0_g43412;
				float4 BOTTOM_FINAL_ALBEDO612_g43387 = temp_output_2592_78_g43387;
				float temp_output_62_0_g43406 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43409 = lerp( ase_worldPos , packedInput.ase_texcoord5.xyz , temp_output_62_0_g43406);
				float3 break10_g43406 = lerpResult99_g43409;
				float2 appendResult13_g43406 = (float2(break10_g43406.y , break10_g43406.z));
				float2 appendResult897_g43387 = (float2(_Top_TilingX , _Top_TilingY));
				float2 TOP_Tilling892_g43387 = appendResult897_g43387;
				float2 temp_output_60_0_g43406 = TOP_Tilling892_g43387;
				float2 appendResult896_g43387 = (float2(_Top_OffsetX , _Top_OffsetY));
				float2 TOP_Offset869_g43387 = appendResult896_g43387;
				float2 temp_output_61_0_g43406 = TOP_Offset869_g43387;
				float2 UV_0121_g43406 = ( ( appendResult13_g43406 * temp_output_60_0_g43406 ) + temp_output_61_0_g43406 );
				float3 WorldNormal83_g43407 = normalWS;
				float3 lerpResult99_g43407 = lerp( WorldNormal83_g43407 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43407 , 0.0 ) ).xyz , temp_output_62_0_g43406);
				float3 temp_output_33_0_g43406 = abs( lerpResult99_g43407 );
				float dotResult30_g43406 = dot( temp_output_33_0_g43406 , float3(1,1,1) );
				float3 BLEND36_g43406 = ( temp_output_33_0_g43406 / dotResult30_g43406 );
				float3 break48_g43406 = BLEND36_g43406;
				float2 appendResult15_g43406 = (float2(break10_g43406.x , break10_g43406.z));
				float2 UV_0220_g43406 = ( ( appendResult15_g43406 * temp_output_60_0_g43406 ) + temp_output_61_0_g43406 );
				float2 appendResult25_g43406 = (float2(break10_g43406.x , break10_g43406.y));
				float2 UV_0327_g43406 = ( ( appendResult25_g43406 * temp_output_60_0_g43406 ) + temp_output_61_0_g43406 );
				float4 temp_output_59_0_g43406 = ( ( ( SAMPLE_TEXTURE2D( _Top_MainTex, sampler_trilinear_repeat_aniso2, UV_0121_g43406 ) * break48_g43406.x ) + ( SAMPLE_TEXTURE2D( _Top_MainTex, sampler_trilinear_repeat_aniso2, UV_0220_g43406 ) * break48_g43406.y ) ) + ( SAMPLE_TEXTURE2D( _Top_MainTex, sampler_trilinear_repeat_aniso2, UV_0327_g43406 ) * break48_g43406.z ) );
				float4 temp_output_2524_78_g43387 = temp_output_59_0_g43406;
				float4 TOP_FINAL_ALBEDO632_g43387 = temp_output_2524_78_g43387;
				float3 break109_g43412 = BLEND36_g43412;
				float4 temp_output_2592_71_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Bottom_BumpMap, sampler_trilinear_repeat_aniso2, UV_0121_g43412 ) * break109_g43412.x ) + ( SAMPLE_TEXTURE2D( _Bottom_BumpMap, sampler_trilinear_repeat_aniso2, UV_0220_g43412 ) * break109_g43412.y ) ) + ( SAMPLE_TEXTURE2D( _Bottom_BumpMap, sampler_trilinear_repeat_aniso2, UV_0327_g43412 ) * break109_g43412.z ) );
				float4 BOTTOM_FINAL_NORMAL614_g43387 = temp_output_2592_71_g43387;
				float4 temp_output_1_0_g43391 = BOTTOM_FINAL_NORMAL614_g43387;
				float temp_output_8_0_g43391 = _Bottom_NormalStrength;
				float3 unpack52_g43391 = UnpackNormalScale( temp_output_1_0_g43391, temp_output_8_0_g43391 );
				unpack52_g43391.z = lerp( 1, unpack52_g43391.z, saturate(temp_output_8_0_g43391) );
				float3 break109_g43406 = BLEND36_g43406;
				float4 temp_output_2524_71_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Top_BumpMap, sampler_trilinear_repeat_aniso2, UV_0121_g43406 ) * break109_g43406.x ) + ( SAMPLE_TEXTURE2D( _Top_BumpMap, sampler_trilinear_repeat_aniso2, UV_0220_g43406 ) * break109_g43406.y ) ) + ( SAMPLE_TEXTURE2D( _Top_BumpMap, sampler_trilinear_repeat_aniso2, UV_0327_g43406 ) * break109_g43406.z ) );
				float4 TOP_FINAL_NORMAL641_g43387 = temp_output_2524_71_g43387;
				float4 temp_output_1_0_g43393 = TOP_FINAL_NORMAL641_g43387;
				float temp_output_8_0_g43393 = _Top_NormalStrength;
				float3 unpack52_g43393 = UnpackNormalScale( temp_output_1_0_g43393, temp_output_8_0_g43393 );
				unpack52_g43393.z = lerp( 1, unpack52_g43393.z, saturate(temp_output_8_0_g43393) );
				float3 WorldNormal83_g43418 = normalWS;
				float3 lerpResult99_g43418 = lerp( WorldNormal83_g43418 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43418 , 0.0 ) ).xyz , _Blend_Space);
				float temp_output_180_0_g43387 = ( 1.0 + _Blend_CoverageFactor );
				float _Coverage_Normal2553_g43387 = saturate( pow( saturate( ( lerpResult99_g43418.y * _Blend_CoverageAmount * temp_output_180_0_g43387 ) ) , _Blend_CoverageFalloff ) );
				float3 lerpResult47_g43387 = lerp( unpack52_g43391 , unpack52_g43393 , _Coverage_Normal2553_g43387);
				float3 GLOBAL_NORMAL_OUT525_g43387 = lerpResult47_g43387;
				...
				float3 tanNormal81_g43398 = GLOBAL_NORMAL_OUT525_g43387;
				float3 worldNormal81_g43398 = float3(dot(tanToWorld0,tanNormal81_g43398), dot(tanToWorld1,tanNormal81_g43398), dot(tanToWorld2,tanNormal81_g43398));
				float3 WorldNormal83_g43398 = worldNormal81_g43398;
				float3 lerpResult99_g43398 = lerp( WorldNormal83_g43398 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43398 , 0.0 ) ).xyz , _Blend_Space);
				float _Coverage2552_g43387 = saturate( pow( saturate( ( lerpResult99_g43398.y * _Blend_CoverageAmount * temp_output_180_0_g43387 ) ) , _Blend_CoverageFalloff ) );
				float4 lerpResult1269_g43387 = lerp( ( float4( (_Bottom_Color).rgb , 0.0 ) * BOTTOM_FINAL_ALBEDO612_g43387 * _Bottom_Brightness ) , ( float4( (_Top_Color).rgb , 0.0 ) * TOP_FINAL_ALBEDO632_g43387 * _Top_Brightness ) , _Coverage2552_g43387);
				
				float2 texCoord16_g43381 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43383 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43381 );
				float temp_output_8_0_g43383 = _NormalStrengthBent;
				float3 unpack52_g43383 = UnpackNormalScale( temp_output_1_0_g43383, temp_output_8_0_g43383 );
				unpack52_g43383.z = lerp( 1, unpack52_g43383.z, saturate(temp_output_8_0_g43383) );
				float temp_output_74_0_g43383 = ( 1.0 - temp_output_8_0_g43383 );
				float3 lerpResult21_g43381 = lerp( unpack52_g43383 , ASEUnpackNormalRGB(temp_output_1_0_g43383,temp_output_74_0_g43383) , _NormalMapSpace);
				
				float3 break169_g43412 = BLEND36_g43412;
				float4 temp_output_2592_70_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Bottom_MetallicMap, sampler_trilinear_repeat_aniso2, UV_0121_g43412 ) * break169_g43412.x ) + ( SAMPLE_TEXTURE2D( _Bottom_MetallicMap, sampler_trilinear_repeat_aniso2, UV_0220_g43412 ) * break169_g43412.y ) ) + ( SAMPLE_TEXTURE2D( _Bottom_MetallicMap, sampler_trilinear_repeat_aniso2, UV_0327_g43412 ) * break169_g43412.z ) );
				float4 BOTTOM_MASK_MAP_B357_g43387 = temp_output_2592_70_g43387;
				float temp_output_1_0_g43396 = _Bottom_MetallicStrength;
				float BOTTOM_FINAL_METALLIC483_g43387 = ( BOTTOM_MASK_MAP_B357_g43387.r * temp_output_1_0_g43396 );
				float3 break169_g43406 = BLEND36_g43406;
				float4 temp_output_2524_70_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Top_MetallicMap, sampler_trilinear_repeat_aniso2, UV_0121_g43406 ) * break169_g43406.x ) + ( SAMPLE_TEXTURE2D( _Top_MetallicMap, sampler_trilinear_repeat_aniso2, UV_0220_g43406 ) * break169_g43406.y ) ) + ( SAMPLE_TEXTURE2D( _Top_MetallicMap, sampler_trilinear_repeat_aniso2, UV_0327_g43406 ) * break169_g43406.z ) );
				float4 TOP_MASK_MAP_B372_g43387 = temp_output_2524_70_g43387;
				float temp_output_1_0_g43394 = _Top_MetallicStrength;
				float TOP_FINAL_METALLIC482_g43387 = ( TOP_MASK_MAP_B372_g43387.r * temp_output_1_0_g43394 );
				float lerpResult364_g43387 = lerp( BOTTOM_FINAL_METALLIC483_g43387 , TOP_FINAL_METALLIC482_g43387 , _Coverage2552_g43387);
				
				float temp_output_223_0_g43401 = _Bottom_SmoothnessType;
				float m_switch215_g43401 = temp_output_223_0_g43401;
				float3 break154_g43412 = BLEND36_g43412;
				float4 temp_output_2592_72_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Bottom_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0121_g43412 ) * break154_g43412.x ) + ( SAMPLE_TEXTURE2D( _Bottom_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0220_g43412 ) * break154_g43412.y ) ) + ( SAMPLE_TEXTURE2D( _Bottom_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0327_g43412 ) * break154_g43412.z ) );
				float4 BOTTOM_MASK_MAP_G358_g43387 = temp_output_2592_72_g43387;
				float4 temp_cast_17 = (_Bottom_SmoothnessMin).xxxx;
				float4 temp_cast_18 = (_Bottom_SmoothnessMax).xxxx;
				float4 temp_output_216_0_g43401 = (temp_cast_17 + (BOTTOM_MASK_MAP_G358_g43387 - float4( 0,0,0,0 )) * (temp_cast_18 - temp_cast_17) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43401 = temp_output_216_0_g43401;
				float4 temp_cast_19 = (_Bottom_SmoothnessMin).xxxx;
				float4 temp_cast_20 = (_Bottom_SmoothnessMax).xxxx;
				float4 temp_output_214_0_g43401 = ( 1.0 - temp_output_216_0_g43401 );
				float4 m_Roughness215_g43401 = temp_output_214_0_g43401;
				float4 temp_cast_21 = (_Bottom_SmoothnessMin).xxxx;
				float4 temp_cast_22 = (_Bottom_SmoothnessMax).xxxx;
				float3 tanNormal67_g43391 = unpack52_g43391;
				float3 worldNormal67_g43391 = float3(dot(tanToWorld0,tanNormal67_g43391), dot(tanToWorld1,tanNormal67_g43391), dot(tanToWorld2,tanNormal67_g43391));
				float3 BOTTOM_FINAL_NORMAL_WORLD329_g43387 = worldNormal67_g43391;
				float3 temp_output_4_0_g43401 = BOTTOM_FINAL_NORMAL_WORLD329_g43387;
				float3 temp_output_178_0_g43401 = ddx( temp_output_4_0_g43401 );
				float dotResult195_g43401 = dot( temp_output_178_0_g43401 , temp_output_178_0_g43401 );
				float3 temp_output_175_0_g43401 = ddy( temp_output_4_0_g43401 );
				float dotResult201_g43401 = dot( temp_output_175_0_g43401 , temp_output_175_0_g43401 );
				float BOTTOM_ALBEDO_R359_g43387 = temp_output_2592_78_g43387.r;
				float4 temp_cast_23 = (BOTTOM_ALBEDO_R359_g43387).xxxx;
				float4 m_Geometric215_g43401 = ( sqrt( saturate( ( temp_output_216_0_g43401 + ( ( dotResult195_g43401 + dotResult201_g43401 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_23 ) );
				float4 localSmoothnessTypefloat4switch215_g43401 = SmoothnessTypefloat4switch215_g43401( m_switch215_g43401 , m_Smoothness215_g43401 , m_Roughness215_g43401 , m_Geometric215_g43401 );
				float3 break184_g43406 = BLEND36_g43406;
				float4 temp_output_2524_76_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Top_OcclusionMap, sampler_trilinear_repeat_aniso2, UV_0121_g43406 ) * break184_g43406.x ) + ( SAMPLE_TEXTURE2D( _Top_OcclusionMap, sampler_trilinear_repeat_aniso2, UV_0220_g43406 ) * break184_g43406.y ) ) + ( SAMPLE_TEXTURE2D( _Top_OcclusionMap, sampler_trilinear_repeat_aniso2, UV_0327_g43406 ) * break184_g43406.z ) );
				float4 TOP_PBR_Occlusion2835_g43387 = temp_output_2524_76_g43387;
				float temp_output_16_0_g43411 = _Bottom_OcclusionStrengthAO;
				float temp_output_65_0_g43411 = ( 1.0 - temp_output_16_0_g43411 );
				float3 appendResult69_g43411 = (float3(temp_output_65_0_g43411 , temp_output_65_0_g43411 , temp_output_65_0_g43411));
				float4 color77_g43411 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 temp_cast_26 = (packedInput.ase_color.a).xxxx;
				float4 lerpResult75_g43411 = lerp( color77_g43411 , temp_cast_26 , temp_output_16_0_g43411);
				float4 lerpResult83_g43411 = lerp( float4( ( ( ( (TOP_PBR_Occlusion2835_g43387).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43411 ) + appendResult69_g43411 ) , 0.0 ) , lerpResult75_g43411 , _Bottom_OcclusionSource);
				float4 BOTTOM_FINAL_SMOOTHNESS485_g43387 = ( localSmoothnessTypefloat4switch215_g43401 * saturate( lerpResult83_g43411 ) );
				float temp_output_223_0_g43389 = _Top_SmoothnessType;
				float m_switch215_g43389 = temp_output_223_0_g43389;
				float3 break154_g43406 = BLEND36_g43406;
				float4 temp_output_2524_72_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Top_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0121_g43406 ) * break154_g43406.x ) + ( SAMPLE_TEXTURE2D( _Top_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0220_g43406 ) * break154_g43406.y ) ) + ( SAMPLE_TEXTURE2D( _Top_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0327_g43406 ) * break154_g43406.z ) );
				float4 TOP_MASK_MAP_G371_g43387 = temp_output_2524_72_g43387;
				float4 temp_cast_29 = (_Top_SmoothnessMin).xxxx;
				float4 temp_cast_30 = (_Top_SmoothnessMax).xxxx;
				float4 temp_output_216_0_g43389 = (temp_cast_29 + (TOP_MASK_MAP_G371_g43387 - float4( 0,0,0,0 )) * (temp_cast_30 - temp_cast_29) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43389 = temp_output_216_0_g43389;
				float4 temp_cast_31 = (_Top_SmoothnessMin).xxxx;
				float4 temp_cast_32 = (_Top_SmoothnessMax).xxxx;
				float4 temp_output_214_0_g43389 = ( 1.0 - temp_output_216_0_g43389 );
				float4 m_Roughness215_g43389 = temp_output_214_0_g43389;
				float4 temp_cast_33 = (_Top_SmoothnessMin).xxxx;
				float4 temp_cast_34 = (_Top_SmoothnessMax).xxxx;
				float3 tanNormal67_g43393 = unpack52_g43393;
				float3 worldNormal67_g43393 = float3(dot(tanToWorld0,tanNormal67_g43393), dot(tanToWorld1,tanNormal67_g43393), dot(tanToWorld2,tanNormal67_g43393));
				float3 TOP_FINAL_NORMAL_WORLD377_g43387 = worldNormal67_g43393;
				float3 temp_output_4_0_g43389 = TOP_FINAL_NORMAL_WORLD377_g43387;
				float3 temp_output_178_0_g43389 = ddx( temp_output_4_0_g43389 );
				float dotResult195_g43389 = dot( temp_output_178_0_g43389 , temp_output_178_0_g43389 );
				float3 temp_output_175_0_g43389 = ddy( temp_output_4_0_g43389 );
				float dotResult201_g43389 = dot( temp_output_175_0_g43389 , temp_output_175_0_g43389 );
				float TOP_ALBEDO_R2629_g43387 = temp_output_2524_78_g43387.r;
				float4 temp_cast_35 = (TOP_ALBEDO_R2629_g43387).xxxx;
				float4 m_Geometric215_g43389 = ( sqrt( saturate( ( temp_output_216_0_g43389 + ( ( dotResult195_g43389 + dotResult201_g43389 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_35 ) );
				float4 localSmoothnessTypefloat4switch215_g43389 = SmoothnessTypefloat4switch215_g43389( m_switch215_g43389 , m_Smoothness215_g43389 , m_Roughness215_g43389 , m_Geometric215_g43389 );
				float temp_output_16_0_g43405 = _Top_OcclusionStrengthAO;
				float temp_output_65_0_g43405 = ( 1.0 - temp_output_16_0_g43405 );
				float3 appendResult69_g43405 = (float3(temp_output_65_0_g43405 , temp_output_65_0_g43405 , temp_output_65_0_g43405));
				float4 color77_g43405 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 temp_cast_38 = (packedInput.ase_color.a).xxxx;
				float4 lerpResult75_g43405 = lerp( color77_g43405 , temp_cast_38 , temp_output_16_0_g43405);
				float4 lerpResult83_g43405 = lerp( float4( ( ( ( (TOP_PBR_Occlusion2835_g43387).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43405 ) + appendResult69_g43405 ) , 0.0 ) , lerpResult75_g43405 , _Top_OcclusionSource);
				float4 TOP_FINAL_SMOOTHNESS484_g43387 = ( localSmoothnessTypefloat4switch215_g43389 * saturate( lerpResult83_g43405 ) );
				float4 lerpResult365_g43387 = lerp( BOTTOM_FINAL_SMOOTHNESS485_g43387 , TOP_FINAL_SMOOTHNESS484_g43387 , _Coverage2552_g43387);
				
				float4 BOTTOM_FINAL_OCCLUSION487_g43387 = saturate( lerpResult83_g43411 );
				float4 TOP_FINAL_OCCLUSION486_g43387 = saturate( lerpResult83_g43405 );
				float4 lerpResult488_g43387 = lerp( BOTTOM_FINAL_OCCLUSION487_g43387 , TOP_FINAL_OCCLUSION486_g43387 , _Coverage2552_g43387);
				
				float lerpResult3_g43432 = lerp( 0.0 , _SpecularAAScreenSpaceVariance , _EnableGeometricSpecularAA);
				
				float lerpResult4_g43432 = lerp( 0.0 , _SpecularAAThreshold , _EnableGeometricSpecularAA);
				
				surfaceDescription.Albedo = lerpResult1269_g43387.rgb;
				surfaceDescription.Normal = lerpResult47_g43387;
				surfaceDescription.BentNormal = lerpResult21_g43381;
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = lerpResult364_g43387;
				...
				surfaceDescription.Smoothness = lerpResult365_g43387.x;
				surfaceDescription.Occlusion = lerpResult488_g43387.r;
				surfaceDescription.Alpha = lerpResult1269_g43387.a;
				...
				#ifdef _ENABLE_GEOMETRIC_SPECULAR_AA
				surfaceDescription.SpecularAAScreenSpaceVariance = lerpResult3_g43432;
				surfaceDescription.SpecularAAThreshold = lerpResult4_g43432;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord7.xy = inputMesh.uv0.xy;
				outputPackedVaryingsMeshToPS.ase_color = inputMesh.ase_color;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float _UV_SPACE2529_g43387 = _Blend_Space;
				float temp_output_62_0_g43412 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43415 = lerp( ase_worldPos , packedInput.ase_texcoord3.xyz , temp_output_62_0_g43412);
				float3 break10_g43412 = lerpResult99_g43415;
				float2 appendResult13_g43412 = (float2(break10_g43412.y , break10_g43412.z));
				float2 appendResult154_g43387 = (float2(_Bottom_TilingX , _Bottom_TilingY));
				float2 BOTTOM_Tilling563_g43387 = appendResult154_g43387;
				...
				float3 WorldNormal83_g43413 = ase_worldNormal;
				float3 lerpResult99_g43413 = lerp( WorldNormal83_g43413 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43413 , 0.0 ) ).xyz , temp_output_62_0_g43412);
				float3 temp_output_33_0_g43412 = abs( lerpResult99_g43413 );
				float dotResult30_g43412 = dot( temp_output_33_0_g43412 , float3(1,1,1) );
				float3 BLEND36_g43412 = ( temp_output_33_0_g43412 / dotResult30_g43412 );
				...
				float4 BOTTOM_FINAL_ALBEDO612_g43387 = temp_output_2592_78_g43387;
				float temp_output_62_0_g43406 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43409 = lerp( ase_worldPos , packedInput.ase_texcoord3.xyz , temp_output_62_0_g43406);
				float3 break10_g43406 = lerpResult99_g43409;
				float2 appendResult13_g43406 = (float2(break10_g43406.y , break10_g43406.z));
				float2 appendResult897_g43387 = (float2(_Top_TilingX , _Top_TilingY));
				float2 TOP_Tilling892_g43387 = appendResult897_g43387;
				...
				float2 temp_output_61_0_g43406 = TOP_Offset869_g43387;
				float2 UV_0121_g43406 = ( ( appendResult13_g43406 * temp_output_60_0_g43406 ) + temp_output_61_0_g43406 );
				float3 WorldNormal83_g43407 = ase_worldNormal;
				float3 lerpResult99_g43407 = lerp( WorldNormal83_g43407 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43407 , 0.0 ) ).xyz , temp_output_62_0_g43406);
				float3 temp_output_33_0_g43406 = abs( lerpResult99_g43407 );
				float dotResult30_g43406 = dot( temp_output_33_0_g43406 , float3(1,1,1) );
				float3 BLEND36_g43406 = ( temp_output_33_0_g43406 / dotResult30_g43406 );
				...
				float3 unpack52_g43393 = UnpackNormalScale( temp_output_1_0_g43393, temp_output_8_0_g43393 );
				unpack52_g43393.z = lerp( 1, unpack52_g43393.z, saturate(temp_output_8_0_g43393) );
				float3 WorldNormal83_g43418 = ase_worldNormal;
				float3 lerpResult99_g43418 = lerp( WorldNormal83_g43418 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43418 , 0.0 ) ).xyz , _Blend_Space);
				float temp_output_180_0_g43387 = ( 1.0 + _Blend_CoverageFactor );
				float _Coverage_Normal2553_g43387 = saturate( pow( saturate( ( lerpResult99_g43418.y * _Blend_CoverageAmount * temp_output_180_0_g43387 ) ) , _Blend_CoverageFalloff ) );
				float3 lerpResult47_g43387 = lerp( unpack52_g43391 , unpack52_g43393 , _Coverage_Normal2553_g43387);
		...
		Pass
		{
					...
					)
			{
				...
				float _UV_SPACE2529_g43387 = _Blend_Space;
				float temp_output_62_0_g43412 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43415 = lerp( ase_worldPos , packedInput.ase_texcoord1.xyz , temp_output_62_0_g43412);
				float3 break10_g43412 = lerpResult99_g43415;
				float2 appendResult13_g43412 = (float2(break10_g43412.y , break10_g43412.z));
				float2 appendResult154_g43387 = (float2(_Bottom_TilingX , _Bottom_TilingY));
				float2 BOTTOM_Tilling563_g43387 = appendResult154_g43387;
				...
				float4 BOTTOM_FINAL_ALBEDO612_g43387 = temp_output_2592_78_g43387;
				float temp_output_62_0_g43406 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43409 = lerp( ase_worldPos , packedInput.ase_texcoord1.xyz , temp_output_62_0_g43406);
				float3 break10_g43406 = lerpResult99_g43409;
				float2 appendResult13_g43406 = (float2(break10_g43406.y , break10_g43406.z));
				float2 appendResult897_g43387 = (float2(_Top_TilingX , _Top_TilingY));
				float2 TOP_Tilling892_g43387 = appendResult897_g43387;
		...
		Pass
		{
					...
					)
			{
				...
				float4 temp_output_2592_72_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Bottom_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0121_g43412 ) * break154_g43412.x ) + ( SAMPLE_TEXTURE2D( _Bottom_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0220_g43412 ) * break154_g43412.y ) ) + ( SAMPLE_TEXTURE2D( _Bottom_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0327_g43412 ) * break154_g43412.z ) );
				float4 BOTTOM_MASK_MAP_G358_g43387 = temp_output_2592_72_g43387;
				float4 temp_cast_9 = (_Bottom_SmoothnessMin).xxxx;
				float4 temp_cast_10 = (_Bottom_SmoothnessMax).xxxx;
				float4 temp_output_216_0_g43401 = (temp_cast_9 + (BOTTOM_MASK_MAP_G358_g43387 - float4( 0,0,0,0 )) * (temp_cast_10 - temp_cast_9) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43401 = temp_output_216_0_g43401;
				float4 temp_cast_11 = (_Bottom_SmoothnessMin).xxxx;
				float4 temp_cast_12 = (_Bottom_SmoothnessMax).xxxx;
				float4 temp_output_214_0_g43401 = ( 1.0 - temp_output_216_0_g43401 );
				float4 m_Roughness215_g43401 = temp_output_214_0_g43401;
				float4 temp_cast_13 = (_Bottom_SmoothnessMin).xxxx;
				float4 temp_cast_14 = (_Bottom_SmoothnessMax).xxxx;
				float3 ase_worldBitangent = packedInput.ase_texcoord4.xyz;
				float3 tanToWorld0 = float3( tangentWS.xyz.x, ase_worldBitangent.x, normalWS.x );
				float3 tanToWorld1 = float3( tangentWS.xyz.y, ase_worldBitangent.y, normalWS.y );
				float3 tanToWorld2 = float3( tangentWS.xyz.z, ase_worldBitangent.z, normalWS.z );
				...
				float4 temp_output_2592_78_g43387 = temp_output_59_0_g43412;
				float BOTTOM_ALBEDO_R359_g43387 = temp_output_2592_78_g43387.r;
				float4 temp_cast_15 = (BOTTOM_ALBEDO_R359_g43387).xxxx;
				float4 m_Geometric215_g43401 = ( sqrt( saturate( ( temp_output_216_0_g43401 + ( ( dotResult195_g43401 + dotResult201_g43401 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_15 ) );
				float4 localSmoothnessTypefloat4switch215_g43401 = SmoothnessTypefloat4switch215_g43401( m_switch215_g43401 , m_Smoothness215_g43401 , m_Roughness215_g43401 , m_Geometric215_g43401 );
				float3 break184_g43406 = BLEND36_g43406;
				float4 temp_output_2524_76_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Top_OcclusionMap, sampler_trilinear_repeat_aniso2, UV_0121_g43406 ) * break184_g43406.x ) + ( SAMPLE_TEXTURE2D( _Top_OcclusionMap, sampler_trilinear_repeat_aniso2, UV_0220_g43406 ) * break184_g43406.y ) ) + ( SAMPLE_TEXTURE2D( _Top_OcclusionMap, sampler_trilinear_repeat_aniso2, UV_0327_g43406 ) * break184_g43406.z ) );
				float4 TOP_PBR_Occlusion2835_g43387 = temp_output_2524_76_g43387;
				...
				float3 appendResult69_g43411 = (float3(temp_output_65_0_g43411 , temp_output_65_0_g43411 , temp_output_65_0_g43411));
				float4 color77_g43411 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 temp_cast_18 = (packedInput.ase_color.a).xxxx;
				float4 lerpResult75_g43411 = lerp( color77_g43411 , temp_cast_18 , temp_output_16_0_g43411);
				float4 lerpResult83_g43411 = lerp( float4( ( ( ( (TOP_PBR_Occlusion2835_g43387).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43411 ) + appendResult69_g43411 ) , 0.0 ) , lerpResult75_g43411 , _Bottom_OcclusionSource);
				float4 BOTTOM_FINAL_SMOOTHNESS485_g43387 = ( localSmoothnessTypefloat4switch215_g43401 * saturate( lerpResult83_g43411 ) );
				float temp_output_223_0_g43389 = _Top_SmoothnessType;
				float m_switch215_g43389 = temp_output_223_0_g43389;
				...
				float4 temp_output_2524_72_g43387 = ( ( ( SAMPLE_TEXTURE2D( _Top_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0121_g43406 ) * break154_g43406.x ) + ( SAMPLE_TEXTURE2D( _Top_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0220_g43406 ) * break154_g43406.y ) ) + ( SAMPLE_TEXTURE2D( _Top_SmoothnessMap, sampler_trilinear_repeat_aniso2, UV_0327_g43406 ) * break154_g43406.z ) );
				float4 TOP_MASK_MAP_G371_g43387 = temp_output_2524_72_g43387;
				float4 temp_cast_21 = (_Top_SmoothnessMin).xxxx;
				float4 temp_cast_22 = (_Top_SmoothnessMax).xxxx;
				float4 temp_output_216_0_g43389 = (temp_cast_21 + (TOP_MASK_MAP_G371_g43387 - float4( 0,0,0,0 )) * (temp_cast_22 - temp_cast_21) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43389 = temp_output_216_0_g43389;
				float4 temp_cast_23 = (_Top_SmoothnessMin).xxxx;
				float4 temp_cast_24 = (_Top_SmoothnessMax).xxxx;
				float4 temp_output_214_0_g43389 = ( 1.0 - temp_output_216_0_g43389 );
				float4 m_Roughness215_g43389 = temp_output_214_0_g43389;
				float4 temp_cast_25 = (_Top_SmoothnessMin).xxxx;
				float4 temp_cast_26 = (_Top_SmoothnessMax).xxxx;
				float3 tanNormal67_g43393 = unpack52_g43393;
				float3 worldNormal67_g43393 = float3(dot(tanToWorld0,tanNormal67_g43393), dot(tanToWorld1,tanNormal67_g43393), dot(tanToWorld2,tanNormal67_g43393));
				float3 TOP_FINAL_NORMAL_WORLD377_g43387 = worldNormal67_g43393;
				float3 temp_output_4_0_g43389 = TOP_FINAL_NORMAL_WORLD377_g43387;
				...
				float4 temp_output_2524_78_g43387 = temp_output_59_0_g43406;
				float TOP_ALBEDO_R2629_g43387 = temp_output_2524_78_g43387.r;
				float4 temp_cast_27 = (TOP_ALBEDO_R2629_g43387).xxxx;
				float4 m_Geometric215_g43389 = ( sqrt( saturate( ( temp_output_216_0_g43389 + ( ( dotResult195_g43389 + dotResult201_g43389 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_27 ) );
				float4 localSmoothnessTypefloat4switch215_g43389 = SmoothnessTypefloat4switch215_g43389( m_switch215_g43389 , m_Smoothness215_g43389 , m_Roughness215_g43389 , m_Geometric215_g43389 );
				float temp_output_16_0_g43405 = _Top_OcclusionStrengthAO;
				float temp_output_65_0_g43405 = ( 1.0 - temp_output_16_0_g43405 );
				float3 appendResult69_g43405 = (float3(temp_output_65_0_g43405 , temp_output_65_0_g43405 , temp_output_65_0_g43405));
				float4 color77_g43405 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 temp_cast_30 = (packedInput.ase_color.a).xxxx;
				float4 lerpResult75_g43405 = lerp( color77_g43405 , temp_cast_30 , temp_output_16_0_g43405);
				float4 lerpResult83_g43405 = lerp( float4( ( ( ( (TOP_PBR_Occlusion2835_g43387).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43405 ) + appendResult69_g43405 ) , 0.0 ) , lerpResult75_g43405 , _Top_OcclusionSource);
				float4 TOP_FINAL_SMOOTHNESS484_g43387 = ( localSmoothnessTypefloat4switch215_g43389 * saturate( lerpResult83_g43405 ) );
				float3 GLOBAL_NORMAL_OUT525_g43387 = lerpResult47_g43387;
				float3 tanNormal81_g43398 = GLOBAL_NORMAL_OUT525_g43387;
		...
		Pass
		{
				...
				)
			{
				...
				float _UV_SPACE2529_g43387 = _Blend_Space;
				float temp_output_62_0_g43412 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43415 = lerp( ase_worldPos , packedInput.ase_texcoord4.xyz , temp_output_62_0_g43412);
				float3 break10_g43412 = lerpResult99_g43415;
				float2 appendResult13_g43412 = (float2(break10_g43412.y , break10_g43412.z));
				float2 appendResult154_g43387 = (float2(_Bottom_TilingX , _Bottom_TilingY));
				float2 BOTTOM_Tilling563_g43387 = appendResult154_g43387;
				...
				unpack52_g43391.z = lerp( 1, unpack52_g43391.z, saturate(temp_output_8_0_g43391) );
				float temp_output_62_0_g43406 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43409 = lerp( ase_worldPos , packedInput.ase_texcoord4.xyz , temp_output_62_0_g43406);
				float3 break10_g43406 = lerpResult99_g43409;
				float2 appendResult13_g43406 = (float2(break10_g43406.y , break10_g43406.z));
				float2 appendResult897_g43387 = (float2(_Top_TilingX , _Top_TilingY));
				float2 TOP_Tilling892_g43387 = appendResult897_g43387;
		...
		Pass
		{
						...
						)
			{
				...
				float _UV_SPACE2529_g43387 = _Blend_Space;
				float temp_output_62_0_g43412 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43415 = lerp( ase_worldPos , packedInput.ase_texcoord7.xyz , temp_output_62_0_g43412);
				float3 break10_g43412 = lerpResult99_g43415;
				float2 appendResult13_g43412 = (float2(break10_g43412.y , break10_g43412.z));
				float2 appendResult154_g43387 = (float2(_Bottom_TilingX , _Bottom_TilingY));
				float2 BOTTOM_Tilling563_g43387 = appendResult154_g43387;
				...
				float4 BOTTOM_FINAL_ALBEDO612_g43387 = temp_output_2592_78_g43387;
				float temp_output_62_0_g43406 = _UV_SPACE2529_g43387;
				float3 lerpResult99_g43409 = lerp( ase_worldPos , packedInput.ase_texcoord7.xyz , temp_output_62_0_g43406);
				float3 break10_g43406 = lerpResult99_g43409;
				float2 appendResult13_g43406 = (float2(break10_g43406.y , break10_g43406.z));
				float2 appendResult897_g43387 = (float2(_Top_TilingX , _Top_TilingY));
				float2 TOP_Tilling892_g43387 = appendResult897_g43387;
				...
				float2 texCoord16_g43381 = packedInput.ase_texcoord9.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43383 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43381 );
				float temp_output_8_0_g43383 = _NormalStrengthBent;
				float3 unpack52_g43383 = UnpackNormalScale( temp_output_1_0_g43383, temp_output_8_0_g43383 );
				unpack52_g43383.z = lerp( 1, unpack52_g43383.z, saturate(temp_output_8_0_g43383) );
        ...
        Pass
        {
					...
					)
			{
				...
				float2 temp_output_61_0_g43412 = BOTTOM_Offset561_g43387;
				float2 UV_0121_g43412 = ( ( appendResult13_g43412 * temp_output_60_0_g43412 ) + temp_output_61_0_g43412 );
				float3 WorldNormal83_g43413 = packedInput.normalWS;
				float3 lerpResult99_g43413 = lerp( WorldNormal83_g43413 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43413 , 0.0 ) ).xyz , temp_output_62_0_g43412);
				float3 temp_output_33_0_g43412 = abs( lerpResult99_g43413 );
				float dotResult30_g43412 = dot( temp_output_33_0_g43412 , float3(1,1,1) );
				float3 BLEND36_g43412 = ( temp_output_33_0_g43412 / dotResult30_g43412 );
				...
				float2 temp_output_61_0_g43406 = TOP_Offset869_g43387;
				float2 UV_0121_g43406 = ( ( appendResult13_g43406 * temp_output_60_0_g43406 ) + temp_output_61_0_g43406 );
				float3 WorldNormal83_g43407 = packedInput.normalWS;
				float3 lerpResult99_g43407 = lerp( WorldNormal83_g43407 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43407 , 0.0 ) ).xyz , temp_output_62_0_g43406);
				float3 temp_output_33_0_g43406 = abs( lerpResult99_g43407 );
				float dotResult30_g43406 = dot( temp_output_33_0_g43406 , float3(1,1,1) );
				float3 BLEND36_g43406 = ( temp_output_33_0_g43406 / dotResult30_g43406 );
				...
				float3 unpack52_g43393 = UnpackNormalScale( temp_output_1_0_g43393, temp_output_8_0_g43393 );
				unpack52_g43393.z = lerp( 1, unpack52_g43393.z, saturate(temp_output_8_0_g43393) );
				float3 WorldNormal83_g43418 = packedInput.normalWS;
				float3 lerpResult99_g43418 = lerp( WorldNormal83_g43418 , mul( GetWorldToObjectMatrix(), float4( WorldNormal83_g43418 , 0.0 ) ).xyz , _Blend_Space);
				float temp_output_180_0_g43387 = ( 1.0 + _Blend_CoverageFactor );
				float _Coverage_Normal2553_g43387 = saturate( pow( saturate( ( lerpResult99_g43418.y * _Blend_CoverageAmount * temp_output_180_0_g43387 ) ) , _Blend_CoverageFalloff ) );
				float3 lerpResult47_g43387 = lerp( unpack52_g43391 , unpack52_g43393 , _Coverage_Normal2553_g43387);
...
/*ASEBEGIN
Version=18934
71;29.5;1654.5;850.5;-530.7348;924.5482;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;442;1375.652,-245.8267;Inherit;False;287.6667;111;DESF Utility ASE Compile Shaders;1;443;;0,0.1964631,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;443;1383.652,-208.8267;Inherit;False;DESF Utility ASE Compile Shaders;-1;;43380;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;446;1061.986,-758.5482;Inherit;False;DESF HDRP Bent Normal;91;;43381;0d561670847beae4e873b0b6acde227b;0;0;1;FLOAT3;9
Node;AmplifyShaderEditor.FunctionNode;451;1375.318,-752.465;Inherit;False;DESF GUI HDRP Surface 12x;0;;43384;885c2965e574db84c865048979aaeccc;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;448;953.1722,-447.8885;Inherit;False;DESF HDRP Alpha Clip Threshold Shadow;11;;43385;022626164a79e9542a55b37bef6515ec;1,32,0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;445;971.707,-687.4009;Inherit;False;DESF Core Surface Triplanar Spherical;20;;43387;790fb642c24decb4ebda2614061db534;30,524,1,513,1,518,1,2055,1,2614,1,2056,1,2603,1,2609,1,2057,1,1416,0,2604,0,2605,0,2617,0,2615,0,2616,0,2610,0,2543,0,2611,0,2547,0,2549,0,2545,0,1418,0,1417,0,2832,0,2807,0,2804,0,2511,0,2512,0,2510,0,2516,0;0;7;COLOR;0;FLOAT3;122;FLOAT;489;FLOAT4;351;COLOR;352;FLOAT;2818;FLOAT3;2446
Node;AmplifyShaderEditor.FunctionNode;447;988.986,-378.2982;Inherit;False;DESF HDRP Specular Geometric AA;7;;43432;1633571edcb81ad4a8487f62df12fd33;0;0;2;FLOAT;0;FLOAT;1
...
WireConnection;425;0;445;0
WireConnection;425;1;445;122
WireConnection;425;2;446;9
WireConnection;425;4;445;489
WireConnection;425;7;445;351
WireConnection;425;8;445;352
WireConnection;425;9;445;2818
WireConnection;425;30;448;0
WireConnection;425;13;447;0
WireConnection;425;14;447;1
ASEEND*/
//CHKSM=53182A0BAD028C571B556D45F52B928292426B82