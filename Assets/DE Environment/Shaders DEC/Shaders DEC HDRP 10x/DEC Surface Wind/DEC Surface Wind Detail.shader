...
Shader "DEC/Surface Wind/Surface Wind Detail"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Detail_Maskfloat4switch226_g43199( float m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float Detail_BlendVCfloatswitch319_g43199( int m_switch, float m_Red, float m_Green, float m_Blue )
			{
				if(m_switch ==0)
					return m_Red;
				else if(m_switch ==1)
			...
			float3 Detail_Maskfloat3switch221_g43199( float m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float4 SmoothnessTypefloat4switch215_g43295( float m_switch, float4 m_Smoothness, float4 m_Roughness, float4 m_Geometric )
			{
				if(m_switch ==0)
					return m_Smoothness;
				else if(m_switch ==1)
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float m_switch2453_g3455 = _WindMode;
				...
				float WIND_MODE2462_g3455 = _WindMode;
				int m_switch2458_g3455 = (int)WIND_MODE2462_g3455;
				...
				int m_switch2468_g3455 = (int)WIND_MODE2462_g3455;
				...
				int m_switch2312_g3455 = (int)WIND_MODE2462_g3455;
				...
				int m_switch2456_g3455 = (int)WIND_MODE2462_g3455;
				...
				float3 temp_output_309_0_g43284 = localWind_Fadefloat3switch3050_g3455;
				...
				#endif
				float3 vertexValue = temp_output_309_0_g43284;
						...
						)
			{
				...
				float2 appendResult150_g43284 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43284 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43294 = packedInput.ase_texcoord5.xy * appendResult150_g43284 + appendResult151_g43284;
				float2 OUT_UV431_g43284 = texCoord2_g43294;
				float2 UV40_g43292 = OUT_UV431_g43284;
				float4 tex2DNode63_g43292 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float4 OUT_ALBEDO_RGBA1177_g43284 = tex2DNode63_g43292;
				float3 temp_output_7_0_g43284 = ( (_Color).rgb * (OUT_ALBEDO_RGBA1177_g43284).rgb * _Brightness );
				float4 temp_output_39_0_g43199 = float4( temp_output_7_0_g43284 , 0.0 );
				float4 Albedo_RGBA40_g43199 = temp_output_39_0_g43199;
				float m_switch226_g43199 = _EnableDetailMask;
				float2 appendResult132_g43199 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43199 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43199 = packedInput.ase_texcoord5.xy * appendResult132_g43199 + appendResult114_g43199;
				float4 tex2DNode45_g43199 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43199 );
				float4 ALBEDO_OUT255_g43199 = ( _ColorDetail * tex2DNode45_g43199 * _Brightness );
				float4 m_Off226_g43199 = ALBEDO_OUT255_g43199;
				float2 appendResult219_g43199 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43199 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43199 = packedInput.ase_texcoord5.xy * appendResult219_g43199 + appendResult206_g43199;
				float temp_output_15_0_g43200 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43199 ).r );
				float temp_output_26_0_g43200 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43200 = _Detail_BlendHardnessMask;
				float saferPower2_g43200 = abs( max( saturate( (0.0 + (temp_output_15_0_g43200 - ( 1.0 - temp_output_26_0_g43200 )) * (temp_output_24_0_g43200 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43200 ))) ) , 0.0 ) );
				float temp_output_22_0_g43200 = _Detail_BlendFalloffMask;
				float temp_output_403_0_g43199 = saturate( pow( saferPower2_g43200 , ( 1.0 - temp_output_22_0_g43200 ) ) );
				float4 lerpResult225_g43199 = lerp( Albedo_RGBA40_g43199 , ALBEDO_OUT255_g43199 , temp_output_403_0_g43199);
				float4 m_Active226_g43199 = lerpResult225_g43199;
				float saferPower11_g43200 = abs( max( saturate( (1.0 + (temp_output_15_0_g43200 - temp_output_26_0_g43200) * (( 1.0 - temp_output_24_0_g43200 ) - 1.0) / (0.0 - temp_output_26_0_g43200)) ) , 0.0 ) );
				float temp_output_403_21_g43199 = saturate( pow( saferPower11_g43200 , temp_output_22_0_g43200 ) );
				float4 lerpResult408_g43199 = lerp( ALBEDO_OUT255_g43199 , Albedo_RGBA40_g43199 , temp_output_403_21_g43199);
				float4 m_ActiveInverted226_g43199 = lerpResult408_g43199;
				float4 localDetail_Maskfloat4switch226_g43199 = Detail_Maskfloat4switch226_g43199( m_switch226_g43199 , m_Off226_g43199 , m_Active226_g43199 , m_ActiveInverted226_g43199 );
				float4 Mask_Albedo258_g43199 = localDetail_Maskfloat4switch226_g43199;
				float4 break48_g43199 = temp_output_39_0_g43199;
				float Albedo_RGB300_g43199 = ( break48_g43199.x + break48_g43199.y + break48_g43199.z );
				int m_switch319_g43199 = _BlendColor;
				float m_Red319_g43199 = packedInput.ase_color.r;
				float m_Green319_g43199 = packedInput.ase_color.g;
				float m_Blue319_g43199 = packedInput.ase_color.b;
				float localDetail_BlendVCfloatswitch319_g43199 = Detail_BlendVCfloatswitch319_g43199( m_switch319_g43199 , m_Red319_g43199 , m_Green319_g43199 , m_Blue319_g43199 );
				float clampResult47_g43199 = clamp( ( ( ( ( Albedo_RGB300_g43199 - 0.5 ) * ( _DetailBlendInfluence - 0.9 ) ) + ( localDetail_BlendVCfloatswitch319_g43199 - ( _BlendHeight - 0.4 ) ) ) / _DetailBlendSmooth ) , 0.0 , 1.0 );
				float DetailBlend43_g43199 = clampResult47_g43199;
				float4 lerpResult58_g43199 = lerp( Mask_Albedo258_g43199 , Albedo_RGBA40_g43199 , DetailBlend43_g43199);
				float4 lerpResult409_g43199 = lerp( Albedo_RGBA40_g43199 , lerpResult58_g43199 , _EnableDetailMap);
				
				float4 OUT_NORMAL1178_g43284 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float4 temp_output_1_0_g43300 = OUT_NORMAL1178_g43284;
				float temp_output_8_0_g43300 = _NormalStrength;
				float3 unpack52_g43300 = UnpackNormalScale( temp_output_1_0_g43300, temp_output_8_0_g43300 );
				unpack52_g43300.z = lerp( 1, unpack52_g43300.z, saturate(temp_output_8_0_g43300) );
				float3 temp_output_1478_59_g43284 = unpack52_g43300;
				float3 temp_output_38_0_g43199 = temp_output_1478_59_g43284;
				float3 Normal_XYZ260_g43199 = temp_output_38_0_g43199;
				float EnableDetailMask216_g43199 = _EnableDetailMask;
				float m_switch221_g43199 = EnableDetailMask216_g43199;
				float4 temp_output_1_0_g43202 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat_aniso2, texCoord67_g43199 );
				float temp_output_8_0_g43202 = _DetailNormalMapScale;
				float3 unpack52_g43202 = UnpackNormalScale( temp_output_1_0_g43202, temp_output_8_0_g43202 );
				unpack52_g43202.z = lerp( 1, unpack52_g43202.z, saturate(temp_output_8_0_g43202) );
				float3 Detail_Normal199_g43199 = unpack52_g43202;
				float3 m_Off221_g43199 = Detail_Normal199_g43199;
				float3 lerpResult205_g43199 = lerp( Normal_XYZ260_g43199 , Detail_Normal199_g43199 , temp_output_403_0_g43199);
				float3 m_Active221_g43199 = saturate( lerpResult205_g43199 );
				float3 lerpResult406_g43199 = lerp( Detail_Normal199_g43199 , Normal_XYZ260_g43199 , temp_output_403_21_g43199);
				float3 m_ActiveInverted221_g43199 = saturate( lerpResult406_g43199 );
				float3 localDetail_Maskfloat3switch221_g43199 = Detail_Maskfloat3switch221_g43199( m_switch221_g43199 , m_Off221_g43199 , m_Active221_g43199 , m_ActiveInverted221_g43199 );
				float3 Mask_Normal222_g43199 = localDetail_Maskfloat3switch221_g43199;
				float layeredBlendVar413_g43199 = DetailBlend43_g43199;
				float3 layeredBlend413_g43199 = ( lerp( Mask_Normal222_g43199,Normal_XYZ260_g43199 , layeredBlendVar413_g43199 ) );
				float3 normalizeResult414_g43199 = normalize( layeredBlend413_g43199 );
				float3 temp_output_416_0_g43199 = BlendNormal( normalizeResult414_g43199 , Normal_XYZ260_g43199 );
				float EnebleMode122_g43199 = _EnableDetailMap;
				float3 lerpResult410_g43199 = lerp( Normal_XYZ260_g43199 , temp_output_416_0_g43199 , EnebleMode122_g43199);
				
				float2 texCoord16_g43196 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43198 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43196 );
				float temp_output_8_0_g43198 = _NormalStrengthBent;
				float3 unpack52_g43198 = UnpackNormalScale( temp_output_1_0_g43198, temp_output_8_0_g43198 );
				unpack52_g43198.z = lerp( 1, unpack52_g43198.z, saturate(temp_output_8_0_g43198) );
				float temp_output_74_0_g43198 = ( 1.0 - temp_output_8_0_g43198 );
				float3 lerpResult21_g43196 = lerp( unpack52_g43198 , ASEUnpackNormalRGB(temp_output_1_0_g43198,temp_output_74_0_g43198) , _NormalMapSpace);
				
				float4 _MASK_B1440_g43284 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float temp_output_1_0_g43290 = _MetallicStrength;
				
				float temp_output_223_0_g43295 = _SmoothnessSource;
				float m_switch215_g43295 = temp_output_223_0_g43295;
				float4 _MASK_G1438_g43284 = SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float4 temp_cast_11 = (_SmoothnessMin).xxxx;
				float4 temp_cast_12 = (_SmoothnessMax).xxxx;
				float4 temp_output_216_0_g43295 = (temp_cast_11 + (_MASK_G1438_g43284 - float4( 0,0,0,0 )) * (temp_cast_12 - temp_cast_11) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43295 = temp_output_216_0_g43295;
				float4 temp_cast_13 = (_SmoothnessMin).xxxx;
				float4 temp_cast_14 = (_SmoothnessMax).xxxx;
				float4 temp_output_214_0_g43295 = ( 1.0 - temp_output_216_0_g43295 );
				float4 m_Roughness215_g43295 = temp_output_214_0_g43295;
				float4 temp_cast_15 = (_SmoothnessMin).xxxx;
				float4 temp_cast_16 = (_SmoothnessMax).xxxx;
				float3 NORMAL_WORLD_OUT164_g43284 = temp_output_1478_59_g43284;
				float3 temp_output_4_0_g43295 = NORMAL_WORLD_OUT164_g43284;
				float3 temp_output_178_0_g43295 = ddx( temp_output_4_0_g43295 );
				float dotResult195_g43295 = dot( temp_output_178_0_g43295 , temp_output_178_0_g43295 );
				float3 temp_output_175_0_g43295 = ddy( temp_output_4_0_g43295 );
				float dotResult201_g43295 = dot( temp_output_175_0_g43295 , temp_output_175_0_g43295 );
				float4 break377_g43284 = OUT_ALBEDO_RGBA1177_g43284;
				float ALBEDO_R169_g43284 = break377_g43284.r;
				float4 temp_cast_17 = (ALBEDO_R169_g43284).xxxx;
				float4 m_Geometric215_g43295 = ( sqrt( saturate( ( temp_output_216_0_g43295 + ( ( dotResult195_g43295 + dotResult201_g43295 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_17 ) );
				float4 localSmoothnessTypefloat4switch215_g43295 = SmoothnessTypefloat4switch215_g43295( m_switch215_g43295 , m_Smoothness215_g43295 , m_Roughness215_g43295 , m_Geometric215_g43295 );
				float4 temp_output_1556_33_g43284 = localSmoothnessTypefloat4switch215_g43295;
				float4 PBR_Occlusion1641_g43284 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float temp_output_16_0_g43289 = _OcclusionStrengthAO;
				float temp_output_65_0_g43289 = ( 1.0 - temp_output_16_0_g43289 );
				float3 appendResult69_g43289 = (float3(temp_output_65_0_g43289 , temp_output_65_0_g43289 , temp_output_65_0_g43289));
				float4 color77_g43289 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 temp_cast_20 = (packedInput.ase_color.a).xxxx;
				float4 lerpResult75_g43289 = lerp( color77_g43289 , temp_cast_20 , temp_output_16_0_g43289);
				float4 lerpResult83_g43289 = lerp( float4( ( ( ( (PBR_Occlusion1641_g43284).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43289 ) + appendResult69_g43289 ) , 0.0 ) , lerpResult75_g43289 , _OcclusionSource);
				float4 Occlusion1550_g43284 = saturate( lerpResult83_g43289 );
				
				float lerpResult3_g43303 = lerp( 0.0 , _SpecularAAScreenSpaceVariance , _EnableGeometricSpecularAA);
				
				float lerpResult4_g43303 = lerp( 0.0 , _SpecularAAThreshold , _EnableGeometricSpecularAA);
				
				surfaceDescription.Albedo = lerpResult409_g43199.xyz;
				surfaceDescription.Normal = lerpResult410_g43199;
				surfaceDescription.BentNormal = lerpResult21_g43196;
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _MASK_B1440_g43284.r * temp_output_1_0_g43290 );
				...
				surfaceDescription.Smoothness = ( temp_output_1556_33_g43284 * Occlusion1550_g43284 ).x;
				surfaceDescription.Occlusion = saturate( lerpResult83_g43289 ).r;
				surfaceDescription.Alpha = break377_g43284.a;
				...
				#ifdef _ENABLE_GEOMETRIC_SPECULAR_AA
				surfaceDescription.SpecularAAScreenSpaceVariance = lerpResult3_g43303;
				surfaceDescription.SpecularAAThreshold = lerpResult4_g43303;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 appendResult150_g43284 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43284 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43294 = packedInput.ase_texcoord2.xy * appendResult150_g43284 + appendResult151_g43284;
				float2 OUT_UV431_g43284 = texCoord2_g43294;
				float2 UV40_g43292 = OUT_UV431_g43284;
				float4 tex2DNode63_g43292 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float4 OUT_ALBEDO_RGBA1177_g43284 = tex2DNode63_g43292;
				...
				float2 appendResult132_g43199 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43199 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43199 = packedInput.ase_texcoord2.xy * appendResult132_g43199 + appendResult114_g43199;
				float4 tex2DNode45_g43199 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43199 );
				float4 ALBEDO_OUT255_g43199 = ( _ColorDetail * tex2DNode45_g43199 * _Brightness );
				float4 m_Off226_g43199 = ALBEDO_OUT255_g43199;
				float2 appendResult219_g43199 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43199 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43199 = packedInput.ase_texcoord2.xy * appendResult219_g43199 + appendResult206_g43199;
				float temp_output_15_0_g43200 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43199 ).r );
				float temp_output_26_0_g43200 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43200 = _Detail_BlendHardnessMask;
				float saferPower2_g43200 = abs( max( saturate( (0.0 + (temp_output_15_0_g43200 - ( 1.0 - temp_output_26_0_g43200 )) * (temp_output_24_0_g43200 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43200 ))) ) , 0.0 ) );
				...
				float2 texCoord16_g43196 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43198 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43196 );
				float temp_output_8_0_g43198 = _NormalStrengthBent;
				float3 unpack52_g43198 = UnpackNormalScale( temp_output_1_0_g43198, temp_output_8_0_g43198 );
				unpack52_g43198.z = lerp( 1, unpack52_g43198.z, saturate(temp_output_8_0_g43198) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult150_g43284 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43284 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43294 = packedInput.ase_texcoord1.xy * appendResult150_g43284 + appendResult151_g43284;
				float2 OUT_UV431_g43284 = texCoord2_g43294;
				float2 UV40_g43292 = OUT_UV431_g43284;
				float4 tex2DNode63_g43292 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float4 OUT_ALBEDO_RGBA1177_g43284 = tex2DNode63_g43292;
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult150_g43284 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43284 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43294 = packedInput.ase_texcoord3.xy * appendResult150_g43284 + appendResult151_g43284;
				float2 OUT_UV431_g43284 = texCoord2_g43294;
				float2 UV40_g43292 = OUT_UV431_g43284;
				float4 OUT_NORMAL1178_g43284 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float4 temp_output_1_0_g43300 = OUT_NORMAL1178_g43284;
				...
				float2 appendResult132_g43199 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43199 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43199 = packedInput.ase_texcoord3.xy * appendResult132_g43199 + appendResult114_g43199;
				float4 temp_output_1_0_g43202 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat_aniso2, texCoord67_g43199 );
				float temp_output_8_0_g43202 = _DetailNormalMapScale;
				float3 unpack52_g43202 = UnpackNormalScale( temp_output_1_0_g43202, temp_output_8_0_g43202 );
				unpack52_g43202.z = lerp( 1, unpack52_g43202.z, saturate(temp_output_8_0_g43202) );
				...
				float2 appendResult219_g43199 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43199 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43199 = packedInput.ase_texcoord3.xy * appendResult219_g43199 + appendResult206_g43199;
				float temp_output_15_0_g43200 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43199 ).r );
				float temp_output_26_0_g43200 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43200 = _Detail_BlendHardnessMask;
				float saferPower2_g43200 = abs( max( saturate( (0.0 + (temp_output_15_0_g43200 - ( 1.0 - temp_output_26_0_g43200 )) * (temp_output_24_0_g43200 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43200 ))) ) , 0.0 ) );
				...
				float4 temp_output_216_0_g43295 = (temp_cast_4 + (_MASK_G1438_g43284 - float4( 0,0,0,0 )) * (temp_cast_5 - temp_cast_4) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43295 = temp_output_216_0_g43295;
				...
				float4 break377_g43284 = OUT_ALBEDO_RGBA1177_g43284;
				float ALBEDO_R169_g43284 = break377_g43284.r;
				float4 temp_cast_10 = (ALBEDO_R169_g43284).xxxx;
				float4 m_Geometric215_g43295 = ( sqrt( saturate( ( temp_output_216_0_g43295 + ( ( dotResult195_g43295 + dotResult201_g43295 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_10 ) );
				float4 localSmoothnessTypefloat4switch215_g43295 = SmoothnessTypefloat4switch215_g43295( m_switch215_g43295 , m_Smoothness215_g43295 , m_Roughness215_g43295 , m_Geometric215_g43295 );
				float4 temp_output_1556_33_g43284 = localSmoothnessTypefloat4switch215_g43295;
				float4 PBR_Occlusion1641_g43284 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float temp_output_16_0_g43289 = _OcclusionStrengthAO;
				...
				float4 lerpResult75_g43289 = lerp( color77_g43289 , temp_cast_13 , temp_output_16_0_g43289);
				float4 lerpResult83_g43289 = lerp( float4( ( ( ( (PBR_Occlusion1641_g43284).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43289 ) + appendResult69_g43289 ) , 0.0 ) , lerpResult75_g43289 , _OcclusionSource);
				float4 Occlusion1550_g43284 = saturate( lerpResult83_g43289 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 appendResult150_g43284 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43284 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43294 = packedInput.ase_texcoord7.xy * appendResult150_g43284 + appendResult151_g43284;
				float2 OUT_UV431_g43284 = texCoord2_g43294;
				float2 UV40_g43292 = OUT_UV431_g43284;
				float4 tex2DNode63_g43292 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43292 );
				float4 OUT_ALBEDO_RGBA1177_g43284 = tex2DNode63_g43292;
				...
				float2 appendResult132_g43199 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43199 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43199 = packedInput.ase_texcoord7.xy * appendResult132_g43199 + appendResult114_g43199;
				float4 tex2DNode45_g43199 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43199 );
				float4 ALBEDO_OUT255_g43199 = ( _ColorDetail * tex2DNode45_g43199 * _Brightness );
				float4 m_Off226_g43199 = ALBEDO_OUT255_g43199;
				float2 appendResult219_g43199 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43199 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43199 = packedInput.ase_texcoord7.xy * appendResult219_g43199 + appendResult206_g43199;
				float temp_output_15_0_g43200 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43199 ).r );
				float temp_output_26_0_g43200 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43200 = _Detail_BlendHardnessMask;
				float saferPower2_g43200 = abs( max( saturate( (0.0 + (temp_output_15_0_g43200 - ( 1.0 - temp_output_26_0_g43200 )) * (temp_output_24_0_g43200 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43200 ))) ) , 0.0 ) );
				...
				float2 texCoord16_g43196 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43198 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43196 );
				float temp_output_8_0_g43198 = _NormalStrengthBent;
				float3 unpack52_g43198 = UnpackNormalScale( temp_output_1_0_g43198, temp_output_8_0_g43198 );
				unpack52_g43198.z = lerp( 1, unpack52_g43198.z, saturate(temp_output_8_0_g43198) );
...
/*ASEBEGIN
Version=18934
71;29.5;1654.5;850.5;-144.3039;995.844;1;True;True
...
Node;AmplifyShaderEditor.FunctionNode;439;519.561,-685.8406;Inherit;False;DESF Module Wind;106;;3455;b135a554f7e4d0b41bba02c61b34ae74;10,938,0,2881,0,2371,0,2454,0,2433,0,2434,0,2432,0,2457,0,2878,0,2752,0;0;1;FLOAT3;2190
Node;AmplifyShaderEditor.FunctionNode;445;1043.848,-753.9769;Inherit;False;DESF HDRP Bent Normal;76;;43196;0d561670847beae4e873b0b6acde227b;0;0;1;FLOAT3;9
Node;AmplifyShaderEditor.FunctionNode;441;1073.754,-681.6232;Inherit;False;DESF Module Detail;80;;43199;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,346,0,347,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.FunctionNode;450;1339.887,-755.7607;Inherit;False;DESF GUI HDRP Surface 12x;0;;43261;885c2965e574db84c865048979aaeccc;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;447;907.7413,-339.1844;Inherit;False;DESF HDRP Alpha Clip Threshold Shadow;11;;43262;022626164a79e9542a55b37bef6515ec;1,32,0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;443;1350.652,-202.8267;Inherit;False;DESF Utility ASE Compile Shaders;-1;;43283;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;444;729.766,-684.9767;Inherit;False;DESF Core Surface;20;;43284;c3df20d62907cd04086a1eacc41e29d1;18,183,1,1352,1,1382,1,1433,1,1432,1,1434,1,1638,0,1588,0,1491,0,1446,0,1284,0,249,0,1319,0,1318,0,1407,0,1443,0,1337,0,1336,0;1;309;FLOAT3;0,0,0;False;7;FLOAT3;42;FLOAT3;39;FLOAT;0;FLOAT4;41;COLOR;43;FLOAT;55;FLOAT3;313
Node;AmplifyShaderEditor.FunctionNode;446;945.5552,-267.5942;Inherit;False;DESF HDRP Specular Geometric AA;7;;43303;1633571edcb81ad4a8487f62df12fd33;0;0;2;FLOAT;0;FLOAT;1
...
ASEEND*/
//CHKSM=BBBCB6AAB1C4D944B75A29CA1B8A3E04AB8A466B