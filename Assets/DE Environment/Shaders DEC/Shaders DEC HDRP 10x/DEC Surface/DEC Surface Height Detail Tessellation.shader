...
Shader "DEC/Surface/Surface Height Detail Tessellation"
{
	Properties
	{
		...
		[Header(TESSELLATION HDRP)]_TessellationStrength("Tessellation Strength", Range( 0.001 , 100)) = 6
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Detail_Maskfloat4switch226_g43785( float m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float Detail_BlendVCfloatswitch319_g43785( int m_switch, float m_Red, float m_Green, float m_Blue )
			{
				if(m_switch ==0)
					return m_Red;
				else if(m_switch ==1)
			...
			void CalculateUVsSmooth19_g43764( float2 UV, float4 TexelSize, out float2 UV0, out float2 UV1, out float2 UV2, out float2 UV3, out float2 UV4, out float2 UV5, out float2 UV6, out float2 UV7, out float2 UV8 )
			{
				{
			...
			float3 CombineSamplesSmooth31_g43764( float Strength, float S0, float S1, float S2, float S3, float S4, float S5, float S6, float S7, float S8 )
			{
				{
				 float3 normal;
			...
			float3 Detail_Maskfloat3switch221_g43785( float m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float3 temp_output_309_0_g43762 = float3(0,0,0);
				float temp_output_62_0_g43776 = _DisplacementReconstructMode;
				float m_switch74_g43776 = temp_output_62_0_g43776;
				float3 _Vector3 = float3(0,0,0);
				float3 m_Off74_g43776 = _Vector3;
				float2 appendResult150_g43762 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43762 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43772 = inputMesh.ase_texcoord.xy * appendResult150_g43762 + appendResult151_g43762;
				float2 OUT_UV431_g43762 = texCoord2_g43772;
				float2 UV40_g43770 = OUT_UV431_g43762;
				float4 OUT_DISPLAC1180_g43762 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV40_g43770, 0.0 );
				float3 temp_output_190_0_g43776 = (OUT_DISPLAC1180_g43762).xyz;
				float temp_output_61_0_g43776 = _DisplacementReconstructStrength;
				float3 temp_output_200_0_g43776 = ( inputMesh.normalOS * ( temp_output_190_0_g43776 * temp_output_61_0_g43776 ) );
				float3 m_Active74_g43776 = temp_output_200_0_g43776;
				float3 m_ActiveReconstructed74_g43776 = temp_output_200_0_g43776;
				float3 local_Displacement_ModeCfloat3switch74_g43776 = _Displacement_ModeCfloat3switch( m_switch74_g43776 , m_Off74_g43776 , m_Active74_g43776 , m_ActiveReconstructed74_g43776 );
				...
				#endif
				float3 vertexValue = ( temp_output_309_0_g43762 + local_Displacement_ModeCfloat3switch74_g43776 );
						...
						)
			{
				...
				float2 appendResult150_g43762 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43762 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43772 = packedInput.ase_texcoord5.xy * appendResult150_g43762 + appendResult151_g43762;
				float2 OUT_UV431_g43762 = texCoord2_g43772;
				float2 UV40_g43770 = OUT_UV431_g43762;
				...
				float4 temp_output_39_0_g43785 = float4( temp_output_7_0_g43762 , 0.0 );
				float4 Albedo_RGBA40_g43785 = temp_output_39_0_g43785;
				float m_switch226_g43785 = _EnableDetailMask;
				float2 appendResult132_g43785 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43785 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43785 = packedInput.ase_texcoord5.xy * appendResult132_g43785 + appendResult114_g43785;
				float4 tex2DNode45_g43785 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43785 );
				float4 ALBEDO_OUT255_g43785 = ( _ColorDetail * tex2DNode45_g43785 * _Brightness );
				float4 m_Off226_g43785 = ALBEDO_OUT255_g43785;
				float2 appendResult219_g43785 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43785 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43785 = packedInput.ase_texcoord5.xy * appendResult219_g43785 + appendResult206_g43785;
				float temp_output_15_0_g43786 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43785 ).r );
				float temp_output_26_0_g43786 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43786 = _Detail_BlendHardnessMask;
				float saferPower2_g43786 = abs( max( saturate( (0.0 + (temp_output_15_0_g43786 - ( 1.0 - temp_output_26_0_g43786 )) * (temp_output_24_0_g43786 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43786 ))) ) , 0.0 ) );
				float temp_output_22_0_g43786 = _Detail_BlendFalloffMask;
				float temp_output_403_0_g43785 = saturate( pow( saferPower2_g43786 , ( 1.0 - temp_output_22_0_g43786 ) ) );
				float4 lerpResult225_g43785 = lerp( Albedo_RGBA40_g43785 , ALBEDO_OUT255_g43785 , temp_output_403_0_g43785);
				float4 m_Active226_g43785 = lerpResult225_g43785;
				float saferPower11_g43786 = abs( max( saturate( (1.0 + (temp_output_15_0_g43786 - temp_output_26_0_g43786) * (( 1.0 - temp_output_24_0_g43786 ) - 1.0) / (0.0 - temp_output_26_0_g43786)) ) , 0.0 ) );
				float temp_output_403_21_g43785 = saturate( pow( saferPower11_g43786 , temp_output_22_0_g43786 ) );
				float4 lerpResult408_g43785 = lerp( ALBEDO_OUT255_g43785 , Albedo_RGBA40_g43785 , temp_output_403_21_g43785);
				float4 m_ActiveInverted226_g43785 = lerpResult408_g43785;
				float4 localDetail_Maskfloat4switch226_g43785 = Detail_Maskfloat4switch226_g43785( m_switch226_g43785 , m_Off226_g43785 , m_Active226_g43785 , m_ActiveInverted226_g43785 );
				float4 Mask_Albedo258_g43785 = localDetail_Maskfloat4switch226_g43785;
				float4 break48_g43785 = temp_output_39_0_g43785;
				float Albedo_RGB300_g43785 = ( break48_g43785.x + break48_g43785.y + break48_g43785.z );
				int m_switch319_g43785 = _BlendColor;
				float m_Red319_g43785 = packedInput.ase_color.r;
				float m_Green319_g43785 = packedInput.ase_color.g;
				float m_Blue319_g43785 = packedInput.ase_color.b;
				float localDetail_BlendVCfloatswitch319_g43785 = Detail_BlendVCfloatswitch319_g43785( m_switch319_g43785 , m_Red319_g43785 , m_Green319_g43785 , m_Blue319_g43785 );
				float clampResult47_g43785 = clamp( ( ( ( ( Albedo_RGB300_g43785 - 0.5 ) * ( _DetailBlendInfluence - 0.9 ) ) + ( localDetail_BlendVCfloatswitch319_g43785 - ( _BlendHeight - 0.4 ) ) ) / _DetailBlendSmooth ) , 0.0 , 1.0 );
				float DetailBlend43_g43785 = clampResult47_g43785;
				float4 lerpResult58_g43785 = lerp( Mask_Albedo258_g43785 , Albedo_RGBA40_g43785 , DetailBlend43_g43785);
				float4 lerpResult409_g43785 = lerp( Albedo_RGBA40_g43785 , lerpResult58_g43785 , _EnableDetailMap);
				
				float _Displacement_Mode1309_g43762 = _DisplacementReconstructMode;
				float m_switch1310_g43762 = _Displacement_Mode1309_g43762;
				...
				float3 m_Off1310_g43762 = temp_output_1478_59_g43762;
				float3 m_Active1310_g43762 = temp_output_1478_59_g43762;
				float temp_output_1334_0_g43762 = ( _NormalStrength * 2.0 );
				float temp_output_29_0_g43764 = temp_output_1334_0_g43762;
				float Strength31_g43764 = temp_output_29_0_g43764;
				float localCalculateUVsSmooth19_g43764 = ( 0.0 );
				float2 temp_output_96_0_g43764 = OUT_UV431_g43762;
				float2 UV19_g43764 = temp_output_96_0_g43764;
				float4 TexelSize19_g43764 = _ParallaxMap_TexelSize;
				float2 UV019_g43764 = float2( 0,0 );
				float2 UV119_g43764 = float2( 0,0 );
				float2 UV219_g43764 = float2( 0,0 );
				float2 UV319_g43764 = float2( 0,0 );
				float2 UV419_g43764 = float2( 0,0 );
				float2 UV519_g43764 = float2( 0,0 );
				float2 UV619_g43764 = float2( 0,0 );
				float2 UV719_g43764 = float2( 0,0 );
				float2 UV819_g43764 = float2( 0,0 );
				CalculateUVsSmooth19_g43764( UV19_g43764 , TexelSize19_g43764 , UV019_g43764 , UV119_g43764 , UV219_g43764 , UV319_g43764 , UV419_g43764 , UV519_g43764 , UV619_g43764 , UV719_g43764 , UV819_g43764 );
				float4 break13_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV019_g43764 );
				float S031_g43764 = break13_g43764.r;
				float4 break8_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV119_g43764 );
				float S131_g43764 = break8_g43764.r;
				float4 break5_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV219_g43764 );
				float S231_g43764 = break5_g43764.r;
				float4 break3_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV319_g43764 );
				float S331_g43764 = break3_g43764.r;
				float4 break12_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV419_g43764 );
				float S431_g43764 = break12_g43764.r;
				float4 break23_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV519_g43764 );
				float S531_g43764 = break23_g43764.r;
				float4 break44_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV619_g43764 );
				float S631_g43764 = break44_g43764.r;
				float4 break42_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV719_g43764 );
				float S731_g43764 = break42_g43764.r;
				float4 break40_g43764 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV819_g43764 );
				float S831_g43764 = break40_g43764.r;
				float3 localCombineSamplesSmooth31_g43764 = CombineSamplesSmooth31_g43764( Strength31_g43764 , S031_g43764 , S131_g43764 , S231_g43764 , S331_g43764 , S431_g43764 , S531_g43764 , S631_g43764 , S731_g43764 , S831_g43764 );
				float3 m_ActiveReconstructed1310_g43762 = localCombineSamplesSmooth31_g43764;
				float3 local_Displacement_ModeCfloat3switch1310_g43762 = _Displacement_ModeCfloat3switch( m_switch1310_g43762 , m_Off1310_g43762 , m_Active1310_g43762 , m_ActiveReconstructed1310_g43762 );
				float3 temp_output_38_0_g43785 = local_Displacement_ModeCfloat3switch1310_g43762;
				float3 Normal_XYZ260_g43785 = temp_output_38_0_g43785;
				float EnableDetailMask216_g43785 = _EnableDetailMask;
				float m_switch221_g43785 = EnableDetailMask216_g43785;
				float4 temp_output_1_0_g43788 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat_aniso2, texCoord67_g43785 );
				float temp_output_8_0_g43788 = _DetailNormalMapScale;
				float3 unpack52_g43788 = UnpackNormalScale( temp_output_1_0_g43788, temp_output_8_0_g43788 );
				unpack52_g43788.z = lerp( 1, unpack52_g43788.z, saturate(temp_output_8_0_g43788) );
				float3 Detail_Normal199_g43785 = unpack52_g43788;
				float3 m_Off221_g43785 = Detail_Normal199_g43785;
				float3 lerpResult205_g43785 = lerp( Normal_XYZ260_g43785 , Detail_Normal199_g43785 , temp_output_403_0_g43785);
				float3 m_Active221_g43785 = saturate( lerpResult205_g43785 );
				float3 lerpResult406_g43785 = lerp( Detail_Normal199_g43785 , Normal_XYZ260_g43785 , temp_output_403_21_g43785);
				float3 m_ActiveInverted221_g43785 = saturate( lerpResult406_g43785 );
				float3 localDetail_Maskfloat3switch221_g43785 = Detail_Maskfloat3switch221_g43785( m_switch221_g43785 , m_Off221_g43785 , m_Active221_g43785 , m_ActiveInverted221_g43785 );
				float3 Mask_Normal222_g43785 = localDetail_Maskfloat3switch221_g43785;
				float layeredBlendVar413_g43785 = DetailBlend43_g43785;
				float3 layeredBlend413_g43785 = ( lerp( Mask_Normal222_g43785,Normal_XYZ260_g43785 , layeredBlendVar413_g43785 ) );
				float3 normalizeResult414_g43785 = normalize( layeredBlend413_g43785 );
				float3 temp_output_416_0_g43785 = BlendNormal( normalizeResult414_g43785 , Normal_XYZ260_g43785 );
				float EnebleMode122_g43785 = _EnableDetailMap;
				float3 lerpResult410_g43785 = lerp( Normal_XYZ260_g43785 , temp_output_416_0_g43785 , EnebleMode122_g43785);
				
				float2 texCoord16_g43782 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43784 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43782 );
				float temp_output_8_0_g43784 = _NormalStrengthBent;
				...
				float temp_output_74_0_g43784 = ( 1.0 - temp_output_8_0_g43784 );
				float3 lerpResult21_g43782 = lerp( unpack52_g43784 , ASEUnpackNormalRGB(temp_output_1_0_g43784,temp_output_74_0_g43784) , _NormalMapSpace);
				...
				float4 temp_output_216_0_g43773 = (temp_cast_11 + (_MASK_G1438_g43762 - float4( 0,0,0,0 )) * (temp_cast_12 - temp_cast_11) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				...
				float m_switch1387_g43762 = _Displacement_Mode1309_g43762;
				...
				float3 tanNormal67_g43778 = unpack52_g43778;
				float3 worldNormal67_g43778 = float3(dot(tanToWorld0,tanNormal67_g43778), dot(tanToWorld1,tanNormal67_g43778), dot(tanToWorld2,tanNormal67_g43778));
				float3 temp_output_1478_66_g43762 = worldNormal67_g43778;
				float3 m_Off1387_g43762 = temp_output_1478_66_g43762;
				float3 m_Active1387_g43762 = temp_output_1478_66_g43762;
				...
				float3 tangentToWorldDir104_g43764 = mul( ase_tangentToWorldFast, localCombineSamplesSmooth31_g43764 );
				float3 m_ActiveReconstructed1387_g43762 = tangentToWorldDir104_g43764;
				float3 local_Displacement_ModeCfloat3switch1387_g43762 = _Displacement_ModeCfloat3switch( m_switch1387_g43762 , m_Off1387_g43762 , m_Active1387_g43762 , m_ActiveReconstructed1387_g43762 );
				float3 NORMAL_WORLD_OUT164_g43762 = local_Displacement_ModeCfloat3switch1387_g43762;
				...
				float4 temp_cast_17 = (ALBEDO_R169_g43762).xxxx;
				float4 m_Geometric215_g43773 = ( sqrt( saturate( ( temp_output_216_0_g43773 + ( ( dotResult195_g43773 + dotResult201_g43773 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_17 ) );
				...
				float4 lerpResult75_g43767 = lerp( color77_g43767 , temp_cast_20 , temp_output_16_0_g43767);
				...
				float lerpResult3_g43760 = lerp( 0.0 , _SpecularAAScreenSpaceVariance , _EnableGeometricSpecularAA);
				
				float lerpResult4_g43760 = lerp( 0.0 , _SpecularAAThreshold , _EnableGeometricSpecularAA);
				
				surfaceDescription.Albedo = lerpResult409_g43785.xyz;
				surfaceDescription.Normal = lerpResult410_g43785;
				surfaceDescription.BentNormal = lerpResult21_g43782;
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _MASK_B1440_g43762.r * temp_output_1_0_g43768 );
				...
				surfaceDescription.Smoothness = ( temp_output_1556_33_g43762 * Occlusion1550_g43762 ).x;
				surfaceDescription.Occlusion = saturate( lerpResult83_g43767 ).r;
				surfaceDescription.Alpha = break377_g43762.a;
				...
				#ifdef _ENABLE_GEOMETRIC_SPECULAR_AA
				surfaceDescription.SpecularAAScreenSpaceVariance = lerpResult3_g43760;
				surfaceDescription.SpecularAAThreshold = lerpResult4_g43760;
				#endif
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float2 appendResult150_g43762 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43762 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43772 = inputMesh.uv0.xy * appendResult150_g43762 + appendResult151_g43762;
				float2 OUT_UV431_g43762 = texCoord2_g43772;
				float2 UV40_g43770 = OUT_UV431_g43762;
				float4 OUT_DISPLAC1180_g43762 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat_aniso2, UV40_g43770, 0.0 );
				float3 temp_output_190_0_g43776 = (OUT_DISPLAC1180_g43762).xyz;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 appendResult150_g43762 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43762 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43772 = packedInput.ase_texcoord2.xy * appendResult150_g43762 + appendResult151_g43762;
				float2 OUT_UV431_g43762 = texCoord2_g43772;
				float2 UV40_g43770 = OUT_UV431_g43762;
				float4 tex2DNode63_g43770 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43770 );
				float4 OUT_ALBEDO_RGBA1177_g43762 = tex2DNode63_g43770;
				...
				float2 appendResult132_g43785 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43785 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43785 = packedInput.ase_texcoord2.xy * appendResult132_g43785 + appendResult114_g43785;
				float4 tex2DNode45_g43785 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43785 );
				float4 ALBEDO_OUT255_g43785 = ( _ColorDetail * tex2DNode45_g43785 * _Brightness );
				float4 m_Off226_g43785 = ALBEDO_OUT255_g43785;
				float2 appendResult219_g43785 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43785 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43785 = packedInput.ase_texcoord2.xy * appendResult219_g43785 + appendResult206_g43785;
				float temp_output_15_0_g43786 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43785 ).r );
				float temp_output_26_0_g43786 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43786 = _Detail_BlendHardnessMask;
				float saferPower2_g43786 = abs( max( saturate( (0.0 + (temp_output_15_0_g43786 - ( 1.0 - temp_output_26_0_g43786 )) * (temp_output_24_0_g43786 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43786 ))) ) , 0.0 ) );
				...
				float2 texCoord16_g43782 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43784 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43782 );
				float temp_output_8_0_g43784 = _NormalStrengthBent;
				float3 unpack52_g43784 = UnpackNormalScale( temp_output_1_0_g43784, temp_output_8_0_g43784 );
				unpack52_g43784.z = lerp( 1, unpack52_g43784.z, saturate(temp_output_8_0_g43784) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult150_g43762 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43762 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43772 = packedInput.ase_texcoord1.xy * appendResult150_g43762 + appendResult151_g43762;
				float2 OUT_UV431_g43762 = texCoord2_g43772;
				float2 UV40_g43770 = OUT_UV431_g43762;
				float4 tex2DNode63_g43770 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43770 );
				float4 OUT_ALBEDO_RGBA1177_g43762 = tex2DNode63_g43770;
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult150_g43762 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43762 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43772 = packedInput.ase_texcoord3.xy * appendResult150_g43762 + appendResult151_g43762;
				float2 OUT_UV431_g43762 = texCoord2_g43772;
				float2 UV40_g43770 = OUT_UV431_g43762;
				float4 OUT_NORMAL1178_g43762 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat_aniso2, UV40_g43770 );
				float4 temp_output_1_0_g43778 = OUT_NORMAL1178_g43762;
				...
				float2 appendResult132_g43785 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43785 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43785 = packedInput.ase_texcoord3.xy * appendResult132_g43785 + appendResult114_g43785;
				float4 temp_output_1_0_g43788 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat_aniso2, texCoord67_g43785 );
				float temp_output_8_0_g43788 = _DetailNormalMapScale;
				float3 unpack52_g43788 = UnpackNormalScale( temp_output_1_0_g43788, temp_output_8_0_g43788 );
				unpack52_g43788.z = lerp( 1, unpack52_g43788.z, saturate(temp_output_8_0_g43788) );
				...
				float2 appendResult219_g43785 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43785 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43785 = packedInput.ase_texcoord3.xy * appendResult219_g43785 + appendResult206_g43785;
				float temp_output_15_0_g43786 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43785 ).r );
				float temp_output_26_0_g43786 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43786 = _Detail_BlendHardnessMask;
				float saferPower2_g43786 = abs( max( saturate( (0.0 + (temp_output_15_0_g43786 - ( 1.0 - temp_output_26_0_g43786 )) * (temp_output_24_0_g43786 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43786 ))) ) , 0.0 ) );
				...
				float4 temp_output_216_0_g43773 = (temp_cast_4 + (_MASK_G1438_g43762 - float4( 0,0,0,0 )) * (temp_cast_5 - temp_cast_4) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43773 = temp_output_216_0_g43773;
				...
				float4 break377_g43762 = OUT_ALBEDO_RGBA1177_g43762;
				float ALBEDO_R169_g43762 = break377_g43762.r;
				float4 temp_cast_10 = (ALBEDO_R169_g43762).xxxx;
				float4 m_Geometric215_g43773 = ( sqrt( saturate( ( temp_output_216_0_g43773 + ( ( dotResult195_g43773 + dotResult201_g43773 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_10 ) );
				float4 localSmoothnessTypefloat4switch215_g43773 = SmoothnessTypefloat4switch215_g43773( m_switch215_g43773 , m_Smoothness215_g43773 , m_Roughness215_g43773 , m_Geometric215_g43773 );
				float4 temp_output_1556_33_g43762 = localSmoothnessTypefloat4switch215_g43773;
				float4 PBR_Occlusion1641_g43762 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat_aniso2, UV40_g43770 );
				float temp_output_16_0_g43767 = _OcclusionStrengthAO;
				...
				float4 lerpResult75_g43767 = lerp( color77_g43767 , temp_cast_13 , temp_output_16_0_g43767);
				float4 lerpResult83_g43767 = lerp( float4( ( ( ( (PBR_Occlusion1641_g43762).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43767 ) + appendResult69_g43767 ) , 0.0 ) , lerpResult75_g43767 , _OcclusionSource);
				float4 Occlusion1550_g43762 = saturate( lerpResult83_g43767 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 appendResult150_g43762 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43762 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43772 = packedInput.ase_texcoord7.xy * appendResult150_g43762 + appendResult151_g43762;
				float2 OUT_UV431_g43762 = texCoord2_g43772;
				float2 UV40_g43770 = OUT_UV431_g43762;
				float4 tex2DNode63_g43770 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43770 );
				float4 OUT_ALBEDO_RGBA1177_g43762 = tex2DNode63_g43770;
				...
				float2 appendResult132_g43785 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43785 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43785 = packedInput.ase_texcoord7.xy * appendResult132_g43785 + appendResult114_g43785;
				float4 tex2DNode45_g43785 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43785 );
				float4 ALBEDO_OUT255_g43785 = ( _ColorDetail * tex2DNode45_g43785 * _Brightness );
				float4 m_Off226_g43785 = ALBEDO_OUT255_g43785;
				float2 appendResult219_g43785 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43785 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43785 = packedInput.ase_texcoord7.xy * appendResult219_g43785 + appendResult206_g43785;
				float temp_output_15_0_g43786 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43785 ).r );
				float temp_output_26_0_g43786 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43786 = _Detail_BlendHardnessMask;
				float saferPower2_g43786 = abs( max( saturate( (0.0 + (temp_output_15_0_g43786 - ( 1.0 - temp_output_26_0_g43786 )) * (temp_output_24_0_g43786 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43786 ))) ) , 0.0 ) );
				...
				float2 texCoord16_g43782 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43784 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43782 );
				float temp_output_8_0_g43784 = _NormalStrengthBent;
				float3 unpack52_g43784 = UnpackNormalScale( temp_output_1_0_g43784, temp_output_8_0_g43784 );
				unpack52_g43784.z = lerp( 1, unpack52_g43784.z, saturate(temp_output_8_0_g43784) );
...
/*ASEBEGIN
Version=18934
71;29.5;1654.5;850.5;-207.721;1028.675;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;438;1377.864,-1090.011;Inherit;False;292.1923;327.7019;Tessellation;4;442;439;440;441;;0,0,0,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;445;1374.862,-242.8535;Inherit;False;287.6667;109;DESF Utility ASE Compile Shaders;1;446;;0,0.1964631,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;448;1062.48,-750.9006;Inherit;False;DESF HDRP Bent Normal;76;;43782;0d561670847beae4e873b0b6acde227b;0;0;1;FLOAT3;9
Node;AmplifyShaderEditor.RangedFloatNode;442;1402.317,-835.828;Half;False;Property;_TessellationPhong;Tessellation Phong;81;0;Create;False;1;;0;0;True;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;441;1399.864,-1050.303;Half;False;Property;_TessellationStrength;Tessellation Strength;80;0;Create;False;1;;0;0;True;1;Header(TESSELLATION HDRP);False;6;0.5;0.001;100;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;439;1401.179,-906.9092;Half;False;Property;_TessellationDistanceMax;Tessellation Distance Max ;83;0;Create;False;1;;0;0;True;0;False;5;2000;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;453;1374.304,-752.5918;Inherit;False;DESF GUI HDRP Surface 12x;0;;43781;885c2965e574db84c865048979aaeccc;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;444;1090.594,-678.7889;Inherit;False;DESF Module Detail;84;;43785;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,346,0,347,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.FunctionNode;446;1381.862,-205.8535;Inherit;False;DESF Utility ASE Compile Shaders;-1;;43761;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;449;1000.972,-269.4254;Inherit;False;DESF HDRP Specular Geometric AA;7;;43760;1633571edcb81ad4a8487f62df12fd33;0;0;2;FLOAT;0;FLOAT;1
Node;AmplifyShaderEditor.FunctionNode;450;963.1584,-338.0154;Inherit;False;DESF HDRP Alpha Clip Threshold Shadow;11;;43758;022626164a79e9542a55b37bef6515ec;1,32,0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;440;1400.363,-978.088;Half;False;Property;_TessellationDistanceMin;Tessellation Distance Min;82;0;Create;False;1;;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;447;756.7789,-683.604;Inherit;False;DESF Core Surface;20;;43762;c3df20d62907cd04086a1eacc41e29d1;18,183,1,1352,1,1382,1,1433,1,1432,1,1434,1,1638,0,1588,0,1491,0,1446,0,1284,0,249,1,1319,1,1318,1,1407,0,1443,0,1337,0,1336,0;1;309;FLOAT3;0,0,0;False;7;FLOAT3;42;FLOAT3;39;FLOAT;0;FLOAT4;41;COLOR;43;FLOAT;55;FLOAT3;313
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;452;1374.904,-570.6909;Float;False;False;-1;2;Rendering.HighDefinition.LightingShaderGraphGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ScenePickingPass;0;11;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-30;False;False;False;False;False;False;False;False;False;False;False;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
WireConnection;444;39;447;42
WireConnection;444;38;447;39
WireConnection;425;0;444;73
WireConnection;425;1;444;72
WireConnection;425;2;448;9
WireConnection;425;4;447;0
WireConnection;425;7;447;41
WireConnection;425;8;447;43
WireConnection;425;9;447;55
WireConnection;425;30;450;0
WireConnection;425;13;449;0
WireConnection;425;14;449;1
WireConnection;425;11;447;313
ASEEND*/
//CHKSM=24A424F1A56A69050BE03DB92B64FE50B8BAA397