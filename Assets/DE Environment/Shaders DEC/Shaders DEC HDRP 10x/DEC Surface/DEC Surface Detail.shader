...
Shader "DEC/Surface/Surface Detail"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Detail_Maskfloat4switch226_g43309( float m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float Detail_BlendVCfloatswitch319_g43309( int m_switch, float m_Red, float m_Green, float m_Blue )
			{
				if(m_switch ==0)
					return m_Red;
				else if(m_switch ==1)
			...
			float3 Detail_Maskfloat3switch221_g43309( float m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float4 SmoothnessTypefloat4switch215_g43298( float m_switch, float4 m_Smoothness, float4 m_Roughness, float4 m_Geometric )
			{
				if(m_switch ==0)
					return m_Smoothness;
				else if(m_switch ==1)
						...
						)
			{
				...
				float2 appendResult150_g43287 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43287 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43297 = packedInput.ase_texcoord5.xy * appendResult150_g43287 + appendResult151_g43287;
				float2 OUT_UV431_g43287 = texCoord2_g43297;
				float2 UV40_g43295 = OUT_UV431_g43287;
				float4 tex2DNode63_g43295 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float4 OUT_ALBEDO_RGBA1177_g43287 = tex2DNode63_g43295;
				float3 temp_output_7_0_g43287 = ( (_Color).rgb * (OUT_ALBEDO_RGBA1177_g43287).rgb * _Brightness );
				float4 temp_output_39_0_g43309 = float4( temp_output_7_0_g43287 , 0.0 );
				float4 Albedo_RGBA40_g43309 = temp_output_39_0_g43309;
				float m_switch226_g43309 = _EnableDetailMask;
				float2 appendResult132_g43309 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43309 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43309 = packedInput.ase_texcoord5.xy * appendResult132_g43309 + appendResult114_g43309;
				float4 tex2DNode45_g43309 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43309 );
				float4 ALBEDO_OUT255_g43309 = ( _ColorDetail * tex2DNode45_g43309 * _Brightness );
				float4 m_Off226_g43309 = ALBEDO_OUT255_g43309;
				float2 appendResult219_g43309 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43309 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43309 = packedInput.ase_texcoord5.xy * appendResult219_g43309 + appendResult206_g43309;
				float temp_output_15_0_g43310 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43309 ).r );
				float temp_output_26_0_g43310 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43310 = _Detail_BlendHardnessMask;
				float saferPower2_g43310 = abs( max( saturate( (0.0 + (temp_output_15_0_g43310 - ( 1.0 - temp_output_26_0_g43310 )) * (temp_output_24_0_g43310 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43310 ))) ) , 0.0 ) );
				float temp_output_22_0_g43310 = _Detail_BlendFalloffMask;
				float temp_output_403_0_g43309 = saturate( pow( saferPower2_g43310 , ( 1.0 - temp_output_22_0_g43310 ) ) );
				float4 lerpResult225_g43309 = lerp( Albedo_RGBA40_g43309 , ALBEDO_OUT255_g43309 , temp_output_403_0_g43309);
				float4 m_Active226_g43309 = lerpResult225_g43309;
				float saferPower11_g43310 = abs( max( saturate( (1.0 + (temp_output_15_0_g43310 - temp_output_26_0_g43310) * (( 1.0 - temp_output_24_0_g43310 ) - 1.0) / (0.0 - temp_output_26_0_g43310)) ) , 0.0 ) );
				float temp_output_403_21_g43309 = saturate( pow( saferPower11_g43310 , temp_output_22_0_g43310 ) );
				float4 lerpResult408_g43309 = lerp( ALBEDO_OUT255_g43309 , Albedo_RGBA40_g43309 , temp_output_403_21_g43309);
				float4 m_ActiveInverted226_g43309 = lerpResult408_g43309;
				float4 localDetail_Maskfloat4switch226_g43309 = Detail_Maskfloat4switch226_g43309( m_switch226_g43309 , m_Off226_g43309 , m_Active226_g43309 , m_ActiveInverted226_g43309 );
				float4 Mask_Albedo258_g43309 = localDetail_Maskfloat4switch226_g43309;
				float4 break48_g43309 = temp_output_39_0_g43309;
				float Albedo_RGB300_g43309 = ( break48_g43309.x + break48_g43309.y + break48_g43309.z );
				int m_switch319_g43309 = _BlendColor;
				float m_Red319_g43309 = packedInput.ase_color.r;
				float m_Green319_g43309 = packedInput.ase_color.g;
				float m_Blue319_g43309 = packedInput.ase_color.b;
				float localDetail_BlendVCfloatswitch319_g43309 = Detail_BlendVCfloatswitch319_g43309( m_switch319_g43309 , m_Red319_g43309 , m_Green319_g43309 , m_Blue319_g43309 );
				float clampResult47_g43309 = clamp( ( ( ( ( Albedo_RGB300_g43309 - 0.5 ) * ( _DetailBlendInfluence - 0.9 ) ) + ( localDetail_BlendVCfloatswitch319_g43309 - ( _BlendHeight - 0.4 ) ) ) / _DetailBlendSmooth ) , 0.0 , 1.0 );
				float DetailBlend43_g43309 = clampResult47_g43309;
				float4 lerpResult58_g43309 = lerp( Mask_Albedo258_g43309 , Albedo_RGBA40_g43309 , DetailBlend43_g43309);
				float4 lerpResult409_g43309 = lerp( Albedo_RGBA40_g43309 , lerpResult58_g43309 , _EnableDetailMap);
				
				float4 OUT_NORMAL1178_g43287 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float4 temp_output_1_0_g43303 = OUT_NORMAL1178_g43287;
				float temp_output_8_0_g43303 = _NormalStrength;
				float3 unpack52_g43303 = UnpackNormalScale( temp_output_1_0_g43303, temp_output_8_0_g43303 );
				unpack52_g43303.z = lerp( 1, unpack52_g43303.z, saturate(temp_output_8_0_g43303) );
				float3 temp_output_1478_59_g43287 = unpack52_g43303;
				float3 temp_output_38_0_g43309 = temp_output_1478_59_g43287;
				float3 Normal_XYZ260_g43309 = temp_output_38_0_g43309;
				float EnableDetailMask216_g43309 = _EnableDetailMask;
				float m_switch221_g43309 = EnableDetailMask216_g43309;
				float4 temp_output_1_0_g43312 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat_aniso2, texCoord67_g43309 );
				float temp_output_8_0_g43312 = _DetailNormalMapScale;
				float3 unpack52_g43312 = UnpackNormalScale( temp_output_1_0_g43312, temp_output_8_0_g43312 );
				unpack52_g43312.z = lerp( 1, unpack52_g43312.z, saturate(temp_output_8_0_g43312) );
				float3 Detail_Normal199_g43309 = unpack52_g43312;
				float3 m_Off221_g43309 = Detail_Normal199_g43309;
				float3 lerpResult205_g43309 = lerp( Normal_XYZ260_g43309 , Detail_Normal199_g43309 , temp_output_403_0_g43309);
				float3 m_Active221_g43309 = saturate( lerpResult205_g43309 );
				float3 lerpResult406_g43309 = lerp( Detail_Normal199_g43309 , Normal_XYZ260_g43309 , temp_output_403_21_g43309);
				float3 m_ActiveInverted221_g43309 = saturate( lerpResult406_g43309 );
				float3 localDetail_Maskfloat3switch221_g43309 = Detail_Maskfloat3switch221_g43309( m_switch221_g43309 , m_Off221_g43309 , m_Active221_g43309 , m_ActiveInverted221_g43309 );
				float3 Mask_Normal222_g43309 = localDetail_Maskfloat3switch221_g43309;
				float layeredBlendVar413_g43309 = DetailBlend43_g43309;
				float3 layeredBlend413_g43309 = ( lerp( Mask_Normal222_g43309,Normal_XYZ260_g43309 , layeredBlendVar413_g43309 ) );
				float3 normalizeResult414_g43309 = normalize( layeredBlend413_g43309 );
				float3 temp_output_416_0_g43309 = BlendNormal( normalizeResult414_g43309 , Normal_XYZ260_g43309 );
				float EnebleMode122_g43309 = _EnableDetailMap;
				float3 lerpResult410_g43309 = lerp( Normal_XYZ260_g43309 , temp_output_416_0_g43309 , EnebleMode122_g43309);
				
				float2 texCoord16_g43306 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43308 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43306 );
				float temp_output_8_0_g43308 = _NormalStrengthBent;
				float3 unpack52_g43308 = UnpackNormalScale( temp_output_1_0_g43308, temp_output_8_0_g43308 );
				unpack52_g43308.z = lerp( 1, unpack52_g43308.z, saturate(temp_output_8_0_g43308) );
				float temp_output_74_0_g43308 = ( 1.0 - temp_output_8_0_g43308 );
				float3 lerpResult21_g43306 = lerp( unpack52_g43308 , ASEUnpackNormalRGB(temp_output_1_0_g43308,temp_output_74_0_g43308) , _NormalMapSpace);
				
				float4 _MASK_B1440_g43287 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float temp_output_1_0_g43293 = _MetallicStrength;
				
				float temp_output_223_0_g43298 = _SmoothnessSource;
				float m_switch215_g43298 = temp_output_223_0_g43298;
				float4 _MASK_G1438_g43287 = SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float4 temp_cast_11 = (_SmoothnessMin).xxxx;
				float4 temp_cast_12 = (_SmoothnessMax).xxxx;
				float4 temp_output_216_0_g43298 = (temp_cast_11 + (_MASK_G1438_g43287 - float4( 0,0,0,0 )) * (temp_cast_12 - temp_cast_11) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43298 = temp_output_216_0_g43298;
				float4 temp_cast_13 = (_SmoothnessMin).xxxx;
				float4 temp_cast_14 = (_SmoothnessMax).xxxx;
				float4 temp_output_214_0_g43298 = ( 1.0 - temp_output_216_0_g43298 );
				float4 m_Roughness215_g43298 = temp_output_214_0_g43298;
				float4 temp_cast_15 = (_SmoothnessMin).xxxx;
				float4 temp_cast_16 = (_SmoothnessMax).xxxx;
				float3 NORMAL_WORLD_OUT164_g43287 = temp_output_1478_59_g43287;
				float3 temp_output_4_0_g43298 = NORMAL_WORLD_OUT164_g43287;
				float3 temp_output_178_0_g43298 = ddx( temp_output_4_0_g43298 );
				float dotResult195_g43298 = dot( temp_output_178_0_g43298 , temp_output_178_0_g43298 );
				float3 temp_output_175_0_g43298 = ddy( temp_output_4_0_g43298 );
				float dotResult201_g43298 = dot( temp_output_175_0_g43298 , temp_output_175_0_g43298 );
				float4 break377_g43287 = OUT_ALBEDO_RGBA1177_g43287;
				float ALBEDO_R169_g43287 = break377_g43287.r;
				float4 temp_cast_17 = (ALBEDO_R169_g43287).xxxx;
				float4 m_Geometric215_g43298 = ( sqrt( saturate( ( temp_output_216_0_g43298 + ( ( dotResult195_g43298 + dotResult201_g43298 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_17 ) );
				float4 localSmoothnessTypefloat4switch215_g43298 = SmoothnessTypefloat4switch215_g43298( m_switch215_g43298 , m_Smoothness215_g43298 , m_Roughness215_g43298 , m_Geometric215_g43298 );
				float4 temp_output_1556_33_g43287 = localSmoothnessTypefloat4switch215_g43298;
				float4 PBR_Occlusion1641_g43287 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float temp_output_16_0_g43292 = _OcclusionStrengthAO;
				float temp_output_65_0_g43292 = ( 1.0 - temp_output_16_0_g43292 );
				float3 appendResult69_g43292 = (float3(temp_output_65_0_g43292 , temp_output_65_0_g43292 , temp_output_65_0_g43292));
				float4 color77_g43292 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 temp_cast_20 = (packedInput.ase_color.a).xxxx;
				float4 lerpResult75_g43292 = lerp( color77_g43292 , temp_cast_20 , temp_output_16_0_g43292);
				float4 lerpResult83_g43292 = lerp( float4( ( ( ( (PBR_Occlusion1641_g43287).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43292 ) + appendResult69_g43292 ) , 0.0 ) , lerpResult75_g43292 , _OcclusionSource);
				float4 Occlusion1550_g43287 = saturate( lerpResult83_g43292 );
				
				float lerpResult3_g43313 = lerp( 0.0 , _SpecularAAScreenSpaceVariance , _EnableGeometricSpecularAA);
				
				float lerpResult4_g43313 = lerp( 0.0 , _SpecularAAThreshold , _EnableGeometricSpecularAA);
				
				surfaceDescription.Albedo = lerpResult409_g43309.xyz;
				surfaceDescription.Normal = lerpResult410_g43309;
				surfaceDescription.BentNormal = lerpResult21_g43306;
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _MASK_B1440_g43287.r * temp_output_1_0_g43293 );
				...
				surfaceDescription.Smoothness = ( temp_output_1556_33_g43287 * Occlusion1550_g43287 ).x;
				surfaceDescription.Occlusion = saturate( lerpResult83_g43292 ).r;
				surfaceDescription.Alpha = break377_g43287.a;
				...
				#ifdef _ENABLE_GEOMETRIC_SPECULAR_AA
				surfaceDescription.SpecularAAScreenSpaceVariance = lerpResult3_g43313;
				surfaceDescription.SpecularAAThreshold = lerpResult4_g43313;
				#endif
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 appendResult150_g43287 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43287 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43297 = packedInput.ase_texcoord2.xy * appendResult150_g43287 + appendResult151_g43287;
				float2 OUT_UV431_g43287 = texCoord2_g43297;
				float2 UV40_g43295 = OUT_UV431_g43287;
				float4 tex2DNode63_g43295 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float4 OUT_ALBEDO_RGBA1177_g43287 = tex2DNode63_g43295;
				...
				float2 appendResult132_g43309 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43309 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43309 = packedInput.ase_texcoord2.xy * appendResult132_g43309 + appendResult114_g43309;
				float4 tex2DNode45_g43309 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43309 );
				float4 ALBEDO_OUT255_g43309 = ( _ColorDetail * tex2DNode45_g43309 * _Brightness );
				float4 m_Off226_g43309 = ALBEDO_OUT255_g43309;
				float2 appendResult219_g43309 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43309 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43309 = packedInput.ase_texcoord2.xy * appendResult219_g43309 + appendResult206_g43309;
				float temp_output_15_0_g43310 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43309 ).r );
				float temp_output_26_0_g43310 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43310 = _Detail_BlendHardnessMask;
				float saferPower2_g43310 = abs( max( saturate( (0.0 + (temp_output_15_0_g43310 - ( 1.0 - temp_output_26_0_g43310 )) * (temp_output_24_0_g43310 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43310 ))) ) , 0.0 ) );
				...
				float2 texCoord16_g43306 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43308 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43306 );
				float temp_output_8_0_g43308 = _NormalStrengthBent;
				float3 unpack52_g43308 = UnpackNormalScale( temp_output_1_0_g43308, temp_output_8_0_g43308 );
				unpack52_g43308.z = lerp( 1, unpack52_g43308.z, saturate(temp_output_8_0_g43308) );
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult150_g43287 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43287 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43297 = packedInput.ase_texcoord1.xy * appendResult150_g43287 + appendResult151_g43287;
				float2 OUT_UV431_g43287 = texCoord2_g43297;
				float2 UV40_g43295 = OUT_UV431_g43287;
				float4 tex2DNode63_g43295 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float4 OUT_ALBEDO_RGBA1177_g43287 = tex2DNode63_g43295;
		...
		Pass
		{
					...
					)
			{
				...
				float2 appendResult150_g43287 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43287 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43297 = packedInput.ase_texcoord3.xy * appendResult150_g43287 + appendResult151_g43287;
				float2 OUT_UV431_g43287 = texCoord2_g43297;
				float2 UV40_g43295 = OUT_UV431_g43287;
				float4 OUT_NORMAL1178_g43287 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float4 temp_output_1_0_g43303 = OUT_NORMAL1178_g43287;
				...
				float2 appendResult132_g43309 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43309 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43309 = packedInput.ase_texcoord3.xy * appendResult132_g43309 + appendResult114_g43309;
				float4 temp_output_1_0_g43312 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat_aniso2, texCoord67_g43309 );
				float temp_output_8_0_g43312 = _DetailNormalMapScale;
				float3 unpack52_g43312 = UnpackNormalScale( temp_output_1_0_g43312, temp_output_8_0_g43312 );
				unpack52_g43312.z = lerp( 1, unpack52_g43312.z, saturate(temp_output_8_0_g43312) );
				...
				float2 appendResult219_g43309 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43309 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43309 = packedInput.ase_texcoord3.xy * appendResult219_g43309 + appendResult206_g43309;
				float temp_output_15_0_g43310 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43309 ).r );
				float temp_output_26_0_g43310 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43310 = _Detail_BlendHardnessMask;
				float saferPower2_g43310 = abs( max( saturate( (0.0 + (temp_output_15_0_g43310 - ( 1.0 - temp_output_26_0_g43310 )) * (temp_output_24_0_g43310 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43310 ))) ) , 0.0 ) );
				...
				float4 temp_output_216_0_g43298 = (temp_cast_4 + (_MASK_G1438_g43287 - float4( 0,0,0,0 )) * (temp_cast_5 - temp_cast_4) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				float4 m_Smoothness215_g43298 = temp_output_216_0_g43298;
				...
				float4 break377_g43287 = OUT_ALBEDO_RGBA1177_g43287;
				float ALBEDO_R169_g43287 = break377_g43287.r;
				float4 temp_cast_10 = (ALBEDO_R169_g43287).xxxx;
				float4 m_Geometric215_g43298 = ( sqrt( saturate( ( temp_output_216_0_g43298 + ( ( dotResult195_g43298 + dotResult201_g43298 ) * 2.0 ) ) ) ) * ( 1.0 - temp_cast_10 ) );
				float4 localSmoothnessTypefloat4switch215_g43298 = SmoothnessTypefloat4switch215_g43298( m_switch215_g43298 , m_Smoothness215_g43298 , m_Roughness215_g43298 , m_Geometric215_g43298 );
				float4 temp_output_1556_33_g43287 = localSmoothnessTypefloat4switch215_g43298;
				float4 PBR_Occlusion1641_g43287 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float temp_output_16_0_g43292 = _OcclusionStrengthAO;
				...
				float4 lerpResult75_g43292 = lerp( color77_g43292 , temp_cast_13 , temp_output_16_0_g43292);
				float4 lerpResult83_g43292 = lerp( float4( ( ( ( (PBR_Occlusion1641_g43287).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43292 ) + appendResult69_g43292 ) , 0.0 ) , lerpResult75_g43292 , _OcclusionSource);
				float4 Occlusion1550_g43287 = saturate( lerpResult83_g43292 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 appendResult150_g43287 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g43287 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43297 = packedInput.ase_texcoord7.xy * appendResult150_g43287 + appendResult151_g43287;
				float2 OUT_UV431_g43287 = texCoord2_g43297;
				float2 UV40_g43295 = OUT_UV431_g43287;
				float4 tex2DNode63_g43295 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat_aniso2, UV40_g43295 );
				float4 OUT_ALBEDO_RGBA1177_g43287 = tex2DNode63_g43295;
				...
				float2 appendResult132_g43309 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43309 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43309 = packedInput.ase_texcoord7.xy * appendResult132_g43309 + appendResult114_g43309;
				float4 tex2DNode45_g43309 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat_aniso2, texCoord67_g43309 );
				float4 ALBEDO_OUT255_g43309 = ( _ColorDetail * tex2DNode45_g43309 * _Brightness );
				float4 m_Off226_g43309 = ALBEDO_OUT255_g43309;
				float2 appendResult219_g43309 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43309 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43309 = packedInput.ase_texcoord7.xy * appendResult219_g43309 + appendResult206_g43309;
				float temp_output_15_0_g43310 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat_aniso2, texCoord220_g43309 ).r );
				float temp_output_26_0_g43310 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43310 = _Detail_BlendHardnessMask;
				float saferPower2_g43310 = abs( max( saturate( (0.0 + (temp_output_15_0_g43310 - ( 1.0 - temp_output_26_0_g43310 )) * (temp_output_24_0_g43310 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43310 ))) ) , 0.0 ) );
				...
				float2 texCoord16_g43306 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float4 temp_output_1_0_g43308 = SAMPLE_TEXTURE2D( _BentNormalMap, sampler_trilinear_repeat_aniso2, texCoord16_g43306 );
				float temp_output_8_0_g43308 = _NormalStrengthBent;
				float3 unpack52_g43308 = UnpackNormalScale( temp_output_1_0_g43308, temp_output_8_0_g43308 );
				unpack52_g43308.z = lerp( 1, unpack52_g43308.z, saturate(temp_output_8_0_g43308) );
...
/*ASEBEGIN
Version=18934
71;29.5;1654.5;850.5;-14.7041;885.84;1;True;True
Node;AmplifyShaderEditor.CommentaryNode;439;1349.957,-243.5895;Inherit;False;283.6667;105;DESF Utility ASE Compile Shaders;1;440;;0,0.1964631,1,1;0;0
Node;AmplifyShaderEditor.FunctionNode;440;1353.957,-205.5895;Inherit;False;DESF Utility ASE Compile Shaders;-1;;43283;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;444;912.1416,-424.1804;Inherit;False;DESF HDRP Alpha Clip Threshold Shadow;11;;43284;022626164a79e9542a55b37bef6515ec;1,32,0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;447;1343.288,-758.7567;Inherit;False;DESF GUI HDRP Surface 12x;0;;43286;885c2965e574db84c865048979aaeccc;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;441;709.8731,-684.34;Inherit;False;DESF Core Surface;20;;43287;c3df20d62907cd04086a1eacc41e29d1;18,183,1,1352,1,1382,1,1433,1,1432,1,1434,1,1638,0,1588,0,1491,0,1446,0,1284,0,249,0,1319,0,1318,0,1407,0,1443,0,1337,0,1336,0;1;309;FLOAT3;0,0,0;False;7;FLOAT3;42;FLOAT3;39;FLOAT;0;FLOAT4;41;COLOR;43;FLOAT;55;FLOAT3;313
Node;AmplifyShaderEditor.FunctionNode;442;1008.955,-748.5897;Inherit;False;DESF HDRP Bent Normal;76;;43306;0d561670847beae4e873b0b6acde227b;0;0;1;FLOAT3;9
Node;AmplifyShaderEditor.FunctionNode;438;1035.175,-678.6311;Inherit;False;DESF Module Detail;80;;43309;49c077198be2bdb409ab6ad879c0ca28;4,200,1,201,1,346,0,347,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.FunctionNode;443;948.9555,-353.59;Inherit;False;DESF HDRP Specular Geometric AA;7;;43313;1633571edcb81ad4a8487f62df12fd33;0;0;2;FLOAT;0;FLOAT;1
...
WireConnection;438;39;441;42
WireConnection;438;38;441;39
WireConnection;425;0;438;73
WireConnection;425;1;438;72
WireConnection;425;2;442;9
WireConnection;425;4;441;0
WireConnection;425;7;441;41
WireConnection;425;8;441;43
WireConnection;425;9;441;55
WireConnection;425;30;444;0
WireConnection;425;13;443;0
WireConnection;425;14;443;1
ASEEND*/
//CHKSM=4B53E5E0F8E2ECD04814676AB8955837C9379F21